...
| Math & CS | Galton board & CLT, Fourier series, Monty Hall & Bayes, gradient descent, sorting race, RSA, information entropy, the Game of Life, Monte Carlo, photolithography, the Kalman filter, simulated annealing, blockchain & proof of work, zero-knowledge proofs, the Lorenz attractor & chaos , JPEG & the DCT |
...
| Everyday technology | Microwave oven, capacitive touch, GPS, transistors to adders, fiber optics, camera sensor, ABS, wind turbine, nuclear reactor, MRI, thermostat, hard drive & flash, elevators & counterweights, the quartz watch, hydro & pumped storage, LiDAR, the buck converter, e-ink, xerography, tire hydroplaning, the pressure cooker, maglev, the PET scan, roller coasters, seatbelts, zippers, inkjet printing, heat pipes, atomic clocks, cellular networks, the CT scanner , incandescent vs LED |

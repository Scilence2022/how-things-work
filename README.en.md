...
| Math & CS | Galton board & CLT, Fourier series, Monty Hall & Bayes, gradient descent, sorting race, RSA, information entropy, the Game of Life, Monte Carlo, photolithography, the Kalman filter, simulated annealing, blockchain & proof of work, zero-knowledge proofs, the Lorenz attractor & chaos , JPEG & the DCT , convolutional networks , Markov chains, A* pathfinding, flocking & boids |

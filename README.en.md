...
| --- | --- |
| Mechanisms | Lockstitch sewing, four-stroke valve timing, planetary gears, worm self-locking, universal joints, escapements, Watt's governor, ball screw, derailleur, flywheel KERS, the CVT, the diesel engine, Ackermann steering, harmonic drive, chain drive & chordal action, differential chain hoist, reaction wheels, the steam engine, the quadcopter , rolling bearings, suspension & dampers , levers & pulleys , involute gears, the gear pump, Newton's cradle, the wiper linkage , the inverted pendulum & self-balance, the brushless DC motor, the torque converter, the tower crane, the suspension bridge, screw jack, cable-stayed bridge, Belt Drive & Tension, Bolt Preload & Loosening, Cycloidal Gears, Magnetic Coupling, Scotch Yoke, Stewart Platform, Gas Spring & Damped Hinge, Intermittent Gearing, Power-Split e-CVT, Journal Bearing & Oil Film, The Pantograph, Wood Joinery (Mortise & Tenon) |
| Chemistry | SN1/SN2/E1/E2 quartet, galvanic ⇄ electrolytic cells, electrophilic addition & Markovnikov's rule, radical chain reactions, benzene aromaticity, conjugation & color, enzyme kinetics, ozone depletion, the catalytic converter, the nitrogen cycle, supercooling & nucleation, radiocarbon dating, flame colors & atomic spectra, crystal-field colors, the mass spectrometer, the Haber–Bosch process , carbon allotropes , shape-memory alloys, fireworks , reverse osmosis, vulcanization, the thermite reaction, photochemical smog , the blast furnace, freezing-point depression, the Hall–Héroult aluminum cell, Fischer esterification, copper electrorefining, The Diels–Alder Reaction, Glass & Vitrification, The Grignard Reaction, Solubility Product & Precipitation, Lithium Dendrites, Photocatalytic Water Splitting, Catalytic Hydrogenation, Diazotization & Azo Dyes, Solvent Extraction, Condensation Polymerization, Electrophilic Aromatic Substitution, The Activity Series & Displacement |
| Biology | DNA replication & telomere wear, ATP synthase, glycolysis → TCA → fermentation, cardiac cycle, the ECG, alveolar gas exchange, nephron counter-current, cochlea & eye, kinesin, antibiotic resistance, the reflex arc, phototropism, transpiration, root-nodule nitrogen fixation, bone remodeling, antibody diversity (V(D)J), allergic reactions, bioluminescence, blood types & transfusion, PCR, myelin & saltatory conduction , the digestive tract, mRNA vaccines, synaptic plasticity & memory , wound healing , stomata & guard cells, the neuromuscular junction, gravitropism, Turing patterns , predators & prey, hydrothermal vents, the honeycomb, insect metamorphosis, trophic pyramid, mycorrhizal network, Cancer & the p53 Guardian, Hox Genes & the Body Plan, Microtubule Dynamic Instability, Pain & Gate Control, Sleep & Brain Waves, Vesicle Transport & SNARE Fusion, Autophagy, The Flagellar Motor, RNA Splicing & Alternative Splicing, Complement Cascade & Membrane Attack Complex, Endosymbiosis & the Origin of Organelles, Ubiquitin–Proteasome System |
| Physics & space | Motor ⇄ generator, double-slit, laser, EM waves, lens imaging, kinetic theory, entropy & phase change, liquid crystals & LCD, the tropical cyclone, exoplanet transits, the harmonic oscillator, Foucault's pendulum, the inverter, thermoelectrics, piezoelectricity, Rayleigh scattering, thin films, glaciers, tidal locking, quantum tunneling, superfluidity, the skin effect, gravitational lensing, the Hohmann transfer, eclipses & the Saros cycle, blackbody radiation & thermal imaging, the photoelectric effect, geysers, the gravity assist, karst caves, ice halos & sundogs, Cherenkov radiation, the monsoon, coral reefs & ocean acidification, comets, accretion disks , AM & FM modulation, quantum entanglement & Bell's theorem, the truth about weightlessness, the cosmic microwave background , ferromagnets & domains, atmospheric pressure & vacuum, the twin paradox, neutron stars & pulsars , the Coriolis effect, the bimetallic strip, impact craters , gas discharge & neon, holography, fluorescence & phosphorescence, seafloor spreading, the cyclotron, diffraction grating, Joule–Thomson effect, radial velocity, Elastic Rebound & the Seismic Cycle, Friction & Stick-Slip, Heat Conduction & Phonons, The Uncertainty Principle, Pauli Exclusion & the Periodic Table, Stress, Strain & Strength, Cosmic Dawn & Reionization, The Cosmic Web, Dark Energy & Cosmic Acceleration, Galaxy Collisions & Mergers, Orbital Resonance, Orbital Rendezvous & Docking, Magnetic Reconnection & Solar Flares, Superposition & Measurement, The Stern–Gerlach Experiment, Gravitational Microlensing, Giant Impact & the Moon, Retrograde Motion, Capacitors & Dielectrics, Groundwater & Aquifers, Matter Waves & Electron Diffraction, Cosmic Inflation & Flatness, Planetary Rings & Shepherd Moons, Venus & the Runaway Greenhouse |
| Math & CS | Galton board & CLT, Fourier series, Monty Hall & Bayes, gradient descent, sorting race, RSA, information entropy, the Game of Life, Monte Carlo, photolithography, the Kalman filter, simulated annealing, blockchain & proof of work, zero-knowledge proofs, the Lorenz attractor & chaos , JPEG & the DCT , convolutional networks , Markov chains, A* pathfinding, flocking & boids , hash tables & the Bloom filter, DNS, the genetic algorithm, the traveling salesman, Diffie–Hellman key exchange, five-stage pipeline, Binary Heap & Priority Queue, Dynamic Programming, The FFT Butterfly, Reinforcement Learning & Q-Learning, Correlation & Regression, Power Laws & Zipf's Law, Bézier Curves & Splines, Consistent Hashing, Regex & Finite Automata, Numerical Integration & Euler's Method, PCA & Eigenvectors, Union-Find & Percolation |
...
| Everyday technology | Microwave oven, capacitive touch, GPS, transistors to adders, fiber optics, camera sensor, ABS, wind turbine, nuclear reactor, MRI, thermostat, hard drive & flash, elevators & counterweights, the quartz watch, hydro & pumped storage, LiDAR, the buck converter, e-ink, xerography, tire hydroplaning, the pressure cooker, maglev, the PET scan, roller coasters, seatbelts, zippers, inkjet printing, heat pipes, atomic clocks, cellular networks, the CT scanner , incandescent vs LED , concrete, X-ray imaging, Wi-Fi , the flush toilet, the washing machine, the fire extinguisher, the relay , the premixed flame & the gas stove, the dishwasher, the circuit breaker, pumped storage, water treatment plant, CPU Cache & Locality, GPU Rasterization, Grid Frequency & Balancing, The Optical Mouse, The Pacemaker, Mechanical Ventilation, Autofocus, Electronic Stability Control, The Rice Cooker, Fingerprint Sensors, Robot Vacuum & SLAM, Fast Charging & USB-PD |
| Fluids & flight | Wing lift & stall, turbofan engines, buoyancy & ship stability, terminal velocity, propeller pitch, submarine ballast, hot-air balloons, Reynolds number, helicopter anti-torque, Venturi tube & flow, Pascal's press, sailing upwind, water hammer, the siphon, the Magnus effect, cavitation & supercavitation, tsunami & shallow-water waves, sonic boom & the Mach cone, the Kármán vortex street, Stokes settling & the centrifuge, capillarity & surface tension, Kelvin–Helmholtz billows, Poiseuille flow, the hydrofoil, swell & deep-water waves, the centrifugal pump & cavitation, non-Newtonian fluids, the boundary layer & separation, the de Laval nozzle, Rayleigh–Bénard convection, river meanders, flapping flight, atmospheric reentry, the ramjet, decompression sickness, the cyclone separator , the airship, the hovercraft, sand dune migration, the river delta , lake turnover, Aeroelastic Flutter, Gliding & Soaring, The Sea Breeze, Turbidity Currents & Density Flow, Vortex Rings, Wing Icing, Snow Avalanche, Wave Breaking, Wingtip Vortices & Wake Turbulence, Kites & Tethered Flight, The Leidenfrost Effect, Water Turbines: Pelton, Francis, Kaplan |
...
### Phase 45 · Cross-Family Gap-Fill Batch 16 (24/24 complete)

- [x] Journal Bearing & Oil Film (lift-off from rest through the wedge; ε solved live from the Sommerfeld number with pressure-ring coloring; oil starvation/whirl regimes) ✅ **journal-bearing/**
- [x] The Pantograph (parallelogram linkage with collinear pivot; live ρ-scaled copy as the tracer draws a star; reverse for enlargement, railway-pantograph namesake noted) ✅ **pantograph/**
- [x] Wood Joinery (slow-mo dovetail seating then wedge-lock under ramping pull; straight-tenon pull-out contrast; moisture slider opening the movement gap) ✅ **wood-joinery/**
- [x] Condensation Polymerization (interfacial nylon drawn onto a spinning spool; Carothers X̄n and Flory histogram marching with conversion; stoichiometry cap and water-removal Le Chatelier contrast) ✅ **condensation-polymerization/**
- [x] Electrophilic Aromatic Substitution (full NO₂⁺ attack → σ-complex → deprotonation restore; five substituents with directing effects and barriers; stalled second nitration) ✅ **electrophilic-aromatic-substitution/**
- [x] The Activity Series & Displacement (copper fuzz blooming on a nail with live color shift; all metal×salt pairs judged by ΔE and ΔG=−nFΔE; oxide-film grinding plus a Zn/Fe/Ag three-beaker lineup) ✅ **metal-displacement/**
- [x] Complement Cascade & MAC (classical/lectin/alternative pathway switch; exponential C3b counter with slow-motion C9-by-C9 pore assembly; C3-deficiency contrast and CD59 host-sparing demo) ✅ **complement-cascade/**
- [x] Endosymbiosis & the Origin of Organelles (a 2-Ga timeline with slow-motion engulf-to-organelle morphing; gene-transfer counter and mito/chloro branches; evidence chips lighting up in turn) ✅ **endosymbiosis/**
- [x] Ubiquitin–Proteasome System (step-by-step E1→E2→E3 play with a chain-length slider; slow-motion pipeline of a protein straightened into the barrel; E3 kill-switch, bortezomib plug and autophagy contrast) ✅ **ubiquitin-proteasome/**
- [x] Capacitors & Dielectrics (d/A/κ sliders reshape C live; isolated-vs-connected slab insertion with RC curve and bulb; breakdown spark demo) ✅ **capacitor-dielectric/**
- [x] Groundwater & Aquifers (pumping/recharge/time-factor sliders; raindrops infiltrating into Darcy flow with a live cone of depression; K presets, artesian well and dye-dispersion demo) ✅ **groundwater/**
- [x] Matter Waves & Electron Diffraction (voltage slider computes λ and fringe spacing live; single-electron/burst modes and polycrystal rings; which-path detector collapses visibility to zero) ✅ **matter-waves/**
- [x] Cosmic Inflation & Flatness (a wrinkled pocket universe evolves phase by phase: Planck → horizon → inflation → reheating → CMB; drag the e-fold slider under 55 and the universe visibly bends and recollapses; |Ω−1|, scale factor and monopole density read out exponentially, quantum ripples hand off to CMB spots) ✅ **cosmic-inflation/**
- [x] Planetary Rings & Shepherd Moons (3,800-particle top-down disk with real Saturn band layout; dyed line shears into a spiral, moon-mass slider reshapes gaps live; 2:1-resonance Cassini Division and F-ring twin-shepherd presets) ✅ **planetary-rings/**
- [x] Venus & the Runaway Greenhouse (grey-atmosphere model calibrated to 289 K and 737 K; distance/CO₂ sliders rewrite surface temperature live — cross the threshold and the ocean boils away while hydrogen motes stream off; D/H climbs by Rayleigh fractionation, with Earth/early-Venus/Venus-today presets) ✅ **venus-greenhouse/**
- [x] Kites & Tethered Flight (lift/weight/tension arrows chained tip-to-tail close into a live force triangle; wind/line/AoA sliders move the equilibrium — too little wind grounds the kite, too steep an angle stalls it; gust spikes, a 4-line figure-8 trail and kilowatt-class power-kite readouts) ✅ **kite-aerodynamics/**
- [x] The Leidenfrost Effect (the same drop on 160/220/280 °C plates splits three ways: spits dry, boils wild, or glides on a vapor cushion; the temperature-offset slider re-divides the boiling regimes live and flips the middle plate's behavior on the spot; LN₂ mode, cushion slow-mo cross-section and a gradient-climb demo) ✅ **leidenfrost-effect/**
- [x] Water Turbines: Pelton, Francis, Kaplan (three cutaway turbines side by side; log-scale head/flow sliders re-pick the winner live; on load an auto tour sweeps 1200 m → 4 m and the highlight changes hands twice; Ns=n√P/H^1.25 bands judged at each type's own rpm, efficiency and flow share follow the pick, cavitation bubble swarm demo) ✅ **water-turbine/**
- [x] Numerical Integration & Euler's Method (Euler/midpoint/RK4 side by side with live energy bars and phase portrait; log-log error-vs-h curves really integrated at init, slope = order; orbit preset shows Euler's spiral escape and the stiff ωh>2 blow-up) ✅ **numerical-integration/**
- [x] PCA & Eigenvectors (a random arrow swings onto the principal axis under power iteration, checked against the analytic angle; correlation slider reshapes the covariance ellipse live; project-and-rebuild animation exposes the dropped variance as red residuals) ✅ **pca-eigenvectors/**
- [x] Union-Find & Percolation (find pulse climbs the chain, then path compression snaps it flat; rank/compression toggles contrast degenerate chains; 8×8 site percolation with live p_c≈0.593 spanning test) ✅ **union-find/**
- [x] Fingerprint Sensors (pressing cross-section builds a ridge-bright grayscale image cell by cell with minutiae overlays; capacitive/ultrasonic/optical modes × wet & dirty toggles expose failure and immunity via live contrast; threshold slider demos the false-accept vs false-reject trade) ✅ **fingerprint-sensor/**
...
### Phase 45 deep dives (condensed)

- **journal-bearing/** — The shaft visibly peels off the bore bottom as the converging wedge ignites a pressure ring, h_min reading out in real microns while friction falls a hundredfold; push rpm on a light load and the journal center starts its ominous half-frequency whirl orbit.
- **pantograph/** — A five-pointed star is traced live while the pencil draws its ρ-scaled twin right beside it, both trails growing in sync; drag the ratio from 0.5× to 3× and the same four bars re-prove the collinearity OF/OD=ρ at every pose.
- **wood-joinery/** — The dovetail seats itself in slow motion, then an auto-ramping pull lights up the flank normals while the joint refuses to budge — switch to the straight tenon and the same force walks it out of the socket, and a moisture slider shows the gap wood movement demands.
- **condensation-polymerization/** — A nylon filament rises continuously off the two-liquid interface onto a spinning spool while the Flory histogram marches toward high n and the water counter ticks with every new bond; nudge the monomer ratio off 1:1 and X̄n slams into its cap in real time.
- **electrophilic-aromatic-substitution/** — NO₂⁺ dives into the glowing π cloud, the ring puckers into a σ-complex with its aromatic halo snuffed out, then HSO₄⁻ plucks H⁺ and the golden ring flares back on — while the energy diagram's dot hops two small hills right beside the dashed aromaticity mountain.
- **metal-displacement/** — The nail sits in blue CuSO₄ while copper fuzz blossoms along its flank and the blue drains to pale green with ΔG=−nFΔE counting down; flip to copper-in-FeSO₄ and nothing moves, then grind aluminum's oxide film and the displacement erupts.
- **complement-cascade/** — Cascade nodes ignite one by one down an arc while a C3b counter explodes exponentially and opsonin dots carpet a bacterium; the signature moment is the MAC assembling in slow motion, C9 monomers dropping into the membrane ring by ring before water floods in and the cell bursts.
- **endosymbiosis/** — Watch the merger in slow motion: an archaeon wraps a swimming bacterium into a double-membrane vacuole, ATP sparks flow outward, the symbiont divides, and glowing genes hop one by one into the nucleus as the organelle shrinks — scrub the 2-billion-year timeline or flip the mitochondrion/chloroplast branch.
- **ubiquitin-proteasome/** — A misfolded protein is seized by an E3, stamped with a glowing K48 chain, then grabbed by the 19S cap, stripped, straightened into a line and fed through the 20S barrel while peptide bits trickle out of the far end; block the barrel with bortezomib and a queue of tagged corpses piles up at the mouth.
- **capacitor-dielectric/** — Slide the dielectric slab between the plates and watch the field lines shrink, the dipoles snap into alignment and C jump to κC₀ — battery off, the voltmeter sags to V₀/κ in real time; battery on, the charge counter leaps κ-fold; push the field past 3 kV/mm and the gap sparks.
- **groundwater/** — Raindrops stab the recharge hill, percolate to the water table and crawl along the Darcy gradient toward the stream; crank the pump and the cone of depression dents the blue surface on the spot — keep overdrafting through the "years" and the land surface itself sags over the well.
- **matter-waves/** — One electron at a time crosses the slits and ticks onto the screen; from random speckle, cos² fringes condense over ~1500 detections while the histogram's live visibility reads 90%+ — flip the which-path detector and each dot turns red or blue as the fringes dissolve into a smooth envelope.
- **cosmic-inflation/** — A crumpled pocket universe studded with red monopoles is inflated into a glass-smooth ball in seconds: wrinkles flatten, twin light-cone rings get outrun by their own expansion, and the Ω readout collapses to 10⁻⁵² before reheating flashes and a speckled CMB sphere takes the stage. Set fewer than 55 e-folds and the same sphere visibly bends, crumples and recollapses on the spot.
- **planetary-rings/** — A top-down ring disk where 3,800 ice grains obey real Saturnian Kepler periods; a dyed radial line winds into a spiral before your eyes. On load the moon's mass ramps up and the gap carves itself open — drag mass or orbit radius and watch the Cassini-style gap and 2:1 resonance marker respond instantly.
- **venus-greenhouse/** — One planet, one slider: drag the orbit inward toward 0.7 AU and the blue ocean first swells with steam, then vanishes as the vapor shell flares white, the surface glows ember-red at 465 °C, and a stream of photolysed hydrogen motes bleeds off into space — the D/H readout climbing a hundredfold marks the crime scene.
- **kite-aerodynamics/** — Three arrows chained nose-to-tail pin a diamond kite against the wind: drag the wind, line-length or bridle sliders and the triangle re-closes at a new equilibrium angle, drooping to the ground when lift loses to weight and snapping taut when a gust yanks the line. Switch to 4-line mode and the kite carves smoking figure-eights, or to power-kite mode where crosswind circles multiply apparent wind five-fold and rope tension reads out as kilowatts.
- **leidenfrost-effect/** — Three hotplates, three fates for one and the same droplet: at 160 °C it spits and dies in seconds, at 220 °C it thrashes itself apart, yet at 280 °C it rises onto a glowing vapor cushion and wanders calmly while its neighbors perish. Drag the offset slider to shove the middle plate across the ~250 °C Leidenfrost point and watch its regime — and personality — flip live; LN₂ mode and a slow-motion cushion cross-section complete the story.
- **water-turbine/** — A machine hall with Pelton, Francis and Kaplan cut open end to end: sweep the head-flow sliders (or let the auto tour run) and the specific-speed needle lands in a different band — the winning turbine lights up and swallows the whole river while the other two dim to 22% flow with plunging η readouts, and a cavitation toggle seeds imploding bubbles on the runner.
- **numerical-integration/** — Three integrators push the same mass while its energy bar creeps up only under Euler and the phase spiral visibly fattens; flip to the orbit preset and the planet's orange trail peels off the dashed Kepler ellipse into an outward spiral, then push h past the stability edge and the whole thing detonates in one frame.
- **pca-eigenvectors/** — A random orange arrow gets multiplied by C over and over, visibly swinging itself onto the long axis of the 1σ ellipse until the convergence notice reads "matches the analytic axis"; hit project-and-rebuild and 140 dots collapse onto one line, their red residual threads showing exactly the variance PC1 was allowed to forget.
- **union-find/** — A glowing pulse climbs the tallest tree hop by hop, then the entire visited chain audibly "snaps" flat onto the root as arcs re-grow in one flash; toggle both heuristics off and forty random unions later the forest sags into long degenerate chains, while the percolation slider sweeps the 8×8 lattice across the 0.593 spanning threshold.
- **fingerprint-sensor/** — The fingertip descends and 784 cells flip in one by one into a ridge-bright grayscale patch while orange minutiae rings pop onto endings and bifurcations; switch to capacitive + wet and the image washes to uniform gray as the verdict flips to reject — then one click to ultrasonic reads the dermis straight through the puddle, and dropping the threshold to 0.35 lets a total stranger's finger unlock the phone.
- **robot-vacuum/** — The orange laser fan sweeps the room one revolution at a time while gray obstacle blocks pop in along the walls; crank the odometry-drift slider and the solid robot visibly parts ways with its blue ghost, smearing the map until a scan-match snaps pose and map back into register — then switch to random bounce and watch the coverage curve turn into the slow ragged gray line.
- **usb-fast-charging/** — Plug in the dumb 5 V brick and the power bar crouches at 10 W; one click to the PD charger and the log rolls Source_Capabilities → Request → Accept as the bar leaps to 45 W and current particles stream down the cable — drag SOC to 79% and watch the curve hit the dashed line, current collapsing into the slow CV tail while a hot ambient slider forces a live renegotiation down to 9 V.

### Phase 44 · Cross-Family Gap-Fill Batch 15 (24/24 complete)

- [x] Gas Spring & Damped Hinge (isothermal F=p·A boost with temperature slider; orifice damping ∝ 1/d² plus oil viscosity; twin angle-time curves with impact marks on one scope) ✅ **gas-spring/**
- [x] Intermittent Gearing (true toothed-arc + locking-rim geometry; driver-centered recesses with adjustable clearance; square-wave ω scope and slow-mo meshing) ✅ **intermittent-gear/**
- [x] Power-split e-CVT (live Zs=30/Zr=78 lever; the MG1 zero-crossing engine-start moment; power particles rerouted by kW and battery SoC bookkeeping) ✅ **power-split-ecvt/**
- [x] Catalytic Hydrogenation (four-step adsorb-dissociate-transfer-desorb single-step playback; Arrhenius temperature and H2 pressure rates; CO poisoning coverage with Pt/Ni comparison) ✅ **catalytic-hydrogenation/**
- [x] Diazotization & Azo Dyes (cold diazotization with over-temperature N2-loss event; three coupling partners shifting λmax; pH slider live-linking spectrum and complementary color) ✅ **diazo-azo-dyes/**
- [x] Solvent Extraction (live D/r/pH sliders steering the partition; 240 particles re-dealt by probability with counted reality; theory bars pitting n portions against one big portion) ✅ **solvent-extraction/**
- [x] Autophagy (nutrient slider presses the mTOR brake, fasting/rapamycin releases it; a sealing double membrane wraps the damaged mitochondrion with LC3 anchors; fusion hydrolyzes cargo into amino-acid particles, damage>75% flips to the apoptosis path) ✅ **autophagy/**
- [x] Flagellar Motor (protons step through stator channels, rotor flashes per ~14° step; Δp slider 0→300 rps, attractant slider retunes tumble probability live; top-view trail straightens from zigzag to run) ✅ **flagellar-motor/**
- [x] RNA Splicing & Alternative Splicing (U1/U2/tri-snRNP stepwise assembly; branch 2′-OH attacks the 5′ site into a lariat, two transesterifications seal a glowing seam; E2/E3 skip toggles reshape the protein strip live) ✅ **rna-splicing/**
- [x] Magnetic Reconnection & Solar Flares (driving/resistivity sliders span Sweet-Parker slow vs fast reconnection; X-point snap with new-loop growth, plasmoid ejection and particle rain; live energy ledger splits B energy into kinetic + heat + particles) ✅ **magnetic-reconnection/**
- [x] Superposition & Measurement (θ/β sliders rotate the Bloch vector and measurement ring live; rapid-fire histogram accumulates cos²((θ−β)/2) with a scrolling outcome tape; eavesdrop-rate slider melts the distribution back to classical) ✅ **quantum-superposition/**
- [x] Stern–Gerlach Experiment (classical vs quantum toggle: continuous band vs two dots live; z→z filtered states stay unsplit, z→x→z replays memory erasure; single-atom mode accumulates spots one by one) ✅ **stern-gerlach/**
- [x] Gravitational Microlensing (symmetric A=(u²+2)/(u√(u²+4)) hump; planetary lens stacks a narrow spike; one-off events demand monitoring millions of stars) ✅ **microlensing/**
- [x] Giant Impact & the Moon (oblique splashdisk with core merging; fates split at the Roche limit; angle/speed sliders decide whether a disk forms) ✅ **moon-formation/**
- [x] Retrograde Motion (slow–station–reverse every ~26 months; heliocentrism in one line: Earth overtakes inside; geocentric star-band view draws the knotted loop live) ✅ **retrograde-motion/**
- [x] Snow Avalanche (layered snowpack with weak-layer safety factor; the 25°–50° danger window; crack snap → slab release → powder cloud outrunning the flow) ✅ **snow-avalanche/**
- [x] Wave Breaking (dispersion-solved shoaling, H∝1/√c_g; live H/h=0.78 criterion; gentle spilling / mid plunging / steep surging side by side) ✅ **wave-breaking/**
- [x] Wingtip Vortices & Wake Turbulence (counter-rotating pair from tip leakage; live Γ∝W/(V·b) and C_L²/(πeAR) accounting; follower-crosses-wake roll upset demo) ✅ **wingtip-vortices/**
- [x] Bézier Curves & Splines (draggable control points with live curve response; degree 1/2/3 switching and a seam-alignment slider for two-segment splines; curvature comb exposing G¹/C¹ and the curvature jump, with an approximating B-spline overlay) ✅ **bezier-splines/**
- [x] Consistent Hashing (node join/leave animations with migrating keys flashing red and a migration-rate readout; mod-N contrast mode recolors nearly everything live; vnode slider flattens load CV in real time) ✅ **consistent-hashing/**
- [x] Regex & Finite Automata (online Thompson compilation of ab|c*, a(a|b)*b, (a+)+b; token cars split at forks, stall at dead ends, light up accept; subset vs backtracking engine toggle with a 2ⁿ path-count readout) ✅ **regex-engine/**
- [x] Autofocus (left/right half-image strips blur and misalign with defocus, snapping to zero; PDAF vs CDAF engine step counts on φ(f) and M(f) curves; a light-level slider shows low-light failure and continuous tracking) ✅ **autofocus/**
- [x] Electronic Stability Control (understeer and oversteer loss scenarios against an ESP on/off toggle; the braked wheel flashes while wanted-vs-actual yaw curves collapse; dry/wet/snow grip slider and speed that crosses the limit) ✅ **esp-stability/**
- [x] The Rice Cooker (temperature curve climbs the plateau, surges past the trip line as the magnet lever snaps in sync; rice/water sliders cook porridge, rice or crunch live; gelatinization and water readouts through simmer and keep-warm phases) ✅ **rice-cooker/**

### Phase 44 deep dives (condensed)

- **gas-spring/** — Two identical doors fall together: the red one accelerates all the way down, slams at 3 rad/s and rebounds twice on its own compressed gas, while the green one hits its damping zone and sinks the last degrees with dignity — the × marks on the oscilloscope tell the whole story. Cut the orifice diameter and watch the crawl get slower.
- **intermittent-gear/** — A driver whose teeth occupy only one arc hands the driven wheel exactly n₁ tooth pitches, then a smooth locking rim glides into driver-centered recesses and freezes it dead — the red "lock window" lights up while the driver keeps spinning. Drag the toothed-arc slider and watch the square-wave speed trace stretch its dwell shelf.
- **power-split-ecvt/** — Three speeds welded onto one tilting lever: drag road speed and watch MG1 sweep from −5000 rpm through zero as the engine fires, then follow power particles as they fork between the direct mechanical route and the sun→MG1→battery→MG2 detour in real time.
- **catalytic-hydrogenation/** — Watch an H2 molecule land on the metal and split into two glowing H atoms, then an ethylene lying flat collect them one by one before ethane leaps away — while the energy-diagram dot hops the 45 kJ/mol staircase that bypasses the 170 kJ/mol wall. Flip the CO switch and the whole dance freezes as gray molecules squat on the sites.
- **diazo-azo-dyes/** — Two pale rings drift together and snap onto a yellow -N=N- bridge: the conjugation bar stretches, the absorption curve lunges from UV into the visible band, and the solution flashes to its complementary color. Push the temperature slider past 5 °C mid-reaction and the diazonium dies in a puff of N2 bubbles.
- **solvent-extraction/** — The funnel rocks, settles, and the violet CCl4 layer suddenly carries most of the color while the water pales; drain, refill, shake again, and the "n portions" bar collapses toward zero far faster than the "one big portion" bar. Push pH past the pKa and watch deprotonation drag every particle back into the aqueous layer.
- **autophagy/** — A damaged mitochondrion gets bagged by a growing double membrane that seals overhead like a drawstring, docks with a purple lysosome, and dissolves into golden amino-acid motes drifting back into the cell. Slide nutrients low to release mTOR — or push damage past 75% and watch cytochrome c burst out instead.
- **flagellar-motor/** — A cutaway flagellar motor where white protons spiral into stator channels one by one, each transit flashing the ring and kicking the rotor ~14°. Raise the attractant slider and the top-view trace on the right visibly relaxes from a drunken zigzag into a straight run.
- **rna-splicing/** — A pre-mRNA of colored exon blocks and gray intron threads; the spliceosome cinches the intron into a lasso, snips it free, and the exon junction flashes where the phosphodiester seam closes. Flip the E2/E3 skip switches and the same transcript splices into a visibly different protein strip.
- **magnetic-reconnection/** — Two antiparallel arcades creep together until the X-point flashes: the lines snip and re-tie, a new loop snaps shut below while a plasmoid and a shower of particles blast out under a flare flash, and the energy ledger on the left moves from blue magnetic to orange kinetic in real time. Switch scenes to load Earth's magnetotail from the dayside and pop an auroral substorm.
- **quantum-superposition/** — Two ghost spin arrows share one atom, their opacities set by cos²(θ/2) and sin²(θ/2), while a measurement ring snaps each trial to + or − and the histogram crawls toward the dashed theoretical line. Push the photon-eavesdropping slider and the sinθ·sinβ interference term — the only quantum thing left — fades into a classical mixture.
- **stern-gerlach/** — A beam of silver atoms bends inside knife-and-groove pole pieces while the screen jumps from the classical orange ghost-band to two crisp dots. Chain z→x→z analyzers and the filtered beam that refused to split splits again — the x measurement ate its memory.
- **microlensing/** — Two image arcs flare and slide around the Einstein ring while the light curve climbs to 20x on the same screen; as the source sweeps the planet's own tiny ring, a narrow spike pops onto the curve live — u₀, planet mass, separation and t_E all retune the event in real time.
- **moon-formation/** — Theia skids in at 45°, its iron core sinks through the molten Earth while hundreds of silicate particles splash into a glowing disk that circularizes, drifts across the marked Roche ring and snowballs into a Moon; dial the impact angle toward head-on and nothing stays in orbit.
- **retrograde-motion/** — A top-down solar system where Earth overtakes Mars at opposition while a geocentric overlay — a star band that follows the observer — traces Mars' knotted loop in real time; click step 3 and the Z-shaped reversal is drawn before your eyes, with dλ/dt flipping red the instant the sky reverses.
- **snow-avalanche/** — The crown line flashes across the slope with a snap, the slab shatters into tumbling blocks that entrain air into a boiling powder cloud racing ahead of the dense core toward a road; the slope slider swings between "friction locks it" and "it only sluffs", and a snow-shed toggle shows the mitigation working.
- **wave-breaking/** — A real dispersion-solved swell steepens over an adjustable bathymetry, throws a curling tongue that smashes into a bubble cloud in slow motion, and one slope slider morphs the same wave from spilling to plunging to a surging runup — with drifters showing circular orbits turning into onshore drift.
- **wingtip-vortices/** — Two counter-rotating vortex ribbons wind off the tips, sink and diffuse behind a C_L-scaled wing while airflow particles show the downwash-between/upwash-outside split; hit "follower crosses wake" and a small jet banks hard as it spears the core — aspect ratio and winglet sliders rewrite the drag bill on the spot.
- **bezier-splines/** — The control polygon collapses layer by layer into a glowing pen tip that sweeps the curve, and dragging any point bends the curve like elastic. Slide the seam handle onto the tangent and the red comb teeth snap into line at the joint — yet a residual kink in the comb betrays that C¹ is still not C².
- **consistent-hashing/** — Keys and servers sparkle on a 0–2³² ring, each key colored by the first node clockwise. Drop a new node onto the ring and only the keys in its counter-clockwise sector blink red and migrate — the readout shows ~1/N while a hash % N toggle watches almost the whole ring recolor at once.
- **regex-engine/** — The input string drives through the NFA as a stream of token-cars: forks split one car into two, dead ends stall in gray, the double-ring accept glows green. Switch to the backtracking view on (a+)+b with thirty a's and the token cloud doubles every character while the counter races past 10⁹ — the subset engine did the same job in 177 steps.
- **autofocus/** — Two bar-code strips above the lens slide out of register as the target defocuses; sweep the lens and the cyan phase line dives through zero exactly at the sharp image — PDAF snaps home in a step while the orange CDAF crawler takes a dozen wiggling probes up the contrast hill. Dim the lights and even the phase line drowns in noise.
- **esp-stability/** — On a wet 55 m corner the car either plows straight off the dotted line or snaps into a tail-out spin — until ESP switches on: one wheel pulses red, the throttle dies, and the orange actual-yaw curve twists back onto the blue wanted curve within seconds. Flip to snow and even the save becomes a drama.
- **rice-cooker/** — The curve crawls onto the 98 °C plateau, sits there for minutes of simmering, then rockets the moment free water dies — and as it crosses the red trip line the permanent magnet in the cutaway base lets go with a popping lever and the heater glow dies. Set the ratio to 1:4 and the plateau just never ends.

### Phase 43 · Cross-Family Gap-Fill Batch 14 (48/48 complete)

- [x] Belt Drive & Tension (belt path solved from true tangents; live T1/T2 slams into the e^(μθ) red line as slip begins; wrap slider 112°→220°, flat vs V-belt μ_eff, tensioner adds wrap and preload) ✅ **belt-drive/**
- [x] Bolt Preload & Loosening (torque-to-preload F≈T/0.2d with the 90% friction split; Junker test drains the clamp-load bar in seconds while the nut spins back; jam nut / nylon / wedge-washer modes compared) ✅ **bolt-preload/**
- [x] Cycloidal Gears (live roller traces epi/hypocycloid flanks; contact dot lights up the describing-arc path; center-error slider jams the cycloid pair while the involute pair keeps spinning) ✅ **cycloid-gears/**
- [x] Magnetic Coupling (field lines skew with lag angle to show τ=sin; stall test makes magnets skip pole-by-pole then snap back with hunting; pair-count and gap sliders verify τmax∝p/d³) ✅ **magnetic-coupling/**
- [x] Scotch Yoke (pin-in-slot gives exact x=r·cosθ; dual traces on one scope show the finite-rod 2nd harmonic; rod-ratio slider makes the deviation vanish as λ grows) ✅ **scotch-yoke/**
- [x] Stewart Platform (six legs telescope live with exact length readouts per pose; swell/circle presets trace a Lissajous figure; serial-arm toggle shows error stacking as growing red cones) ✅ **stewart-platform/**
- [x] The Diels–Alder Reaction (zipper approach, three arrows one concerted turn with exothermic flash; temperature slider crosses the Arrhenius barrier; endo/exo secondary overlap plus butadiene/cyclopentadiene switch) ✅ **diels-alder/**
- [x] Glass & Vitrification (120-atom box: slow cooling orders a shining lattice, fast cooling freezes disorder; live V-T curve draws the crystalline kink vs the Tg bend; annealing relaxes stress, modifier-ion footnote) ✅ **glass-vitrification/**
- [x] The Grignard Reaction (SET oxidative addition and the δ+→δ− polarity flip; carbonyl attack grows a C–C bond, workup gives 1°/2°/3° alcohols; water-quench and CO₂ carboxylation demos) ✅ **grignard-reaction/**
- [x] Solubility Product & Precipitation (dual concentration sliders compute Q against the Ksp line live; titration button flashes turbidity and the counters fall back to equilibrium; common-ion effect and four salts spanning ~8 orders of magnitude) ✅ **ksp-precipitation/**
- [x] Lithium Dendrites (field-focusing feedback, needle vs mossy morphology; separator-piercing flash, short and thermal runaway; C-rate and temperature sliders with graphite-intercalation and SEI comparison) ✅ **lithium-dendrite/**
- [x] Photocatalytic Water Splitting (wavelength slider tests the absorption threshold E=1240/λ; carriers part to both shores bubbling 2:1, cocatalyst off shows recombination; band diagram linked to single-particle vs Z-scheme) ✅ **photocatalysis/**
- [x] Cancer & the p53 Guardian (damage rain → ATM/ATR → p53 tetramers; two-hit allele counter; p53-off runaway clones vs radio/chemo) ✅ **cancer-p53/**
- [x] Hox Genes & the Body Plan (the cluster lights up along the chromosome, colors spread along the A-P axis with collinearity links; gradient slider and Antp boundary shift rewrite identity/appendages live; per-gene knockout, fly/vertebrate switch, malformation count) ✅ **hox-embryogenesis/**
- [x] Microtubule Dynamic Instability (six MTs growing/catastrophing/rescuing with bright caps; [tubulin] slider with live catastrophe stats; taxol freezes mitosis, colchicine dissolves MTs, search-and-capture) ✅ **microtubule-dynamics/**
- [x] Pain & Gate Control (Aδ vs C particle race with myelin contrast; intensity slider coupled to gate opening; rubbing half-closes via Aβ, endorphins shut it fully, plus hyperalgesia/numb extremes) ✅ **pain-gate-control/**
- [x] Sleep & Brain Waves (EEG/EMG scope morphs across W/N1-N2/N3/REM with REM atonia; draggable sleep tower plus hippocampal memory particles; coffee lowers adenosine, slow-wave deprivation tanks the memory score) ✅ **sleep-brainwaves/**
- [x] Vesicle Transport & SNARE Fusion (bud→haul→tether→zipper step playback; slow-mo four-helix zipper with live nm gap; Ca²⁺ trigger and anterograde/retrograde switch) ✅ **vesicle-transport/**
- [x] Elastic Rebound & the Seismic Cycle (road bends into S year by year; rupture step with seismic waves; recurrence statistics and the 1906 footnote) ✅ **elastic-rebound/**
- [x] Friction & Stick-Slip (asperity cold-welding; friction-healing sawtooth stress; quake analogy mode) ✅ **friction-stick-slip/**
- [x] Heat Conduction & Phonons (phonon wave packets relay and scatter; copper/glass/foam with the electron channel; composite wall series-resistance temperature ladder) ✅ **heat-conduction/**
- [x] The Uncertainty Principle (slit slider widens the diffraction fan live; Gaussian minimum-uncertainty spreading; confined-electron kinetic blowup) ✅ **heisenberg-uncertainty/**
- [x] Pauli Exclusion & the Periodic Table (slider fills shells one electron at a time; linked orbital diagram; sawtooth ionization/radius curves) ✅ **pauli-periodic-table/**
- [x] Stress, Strain & Strength (real curves for steel/aluminum/glass/rubber; unloading leaves permanent strain; necking and a glowing fracture face) ✅ **stress-strain/**
- [x] Cosmic Dawn & Reionization (dark ages and zero-metal Pop III blue giants; fresnel ionization bubbles swelling and merging as the Q bar fills; JWST z>10 galaxies and 21cm footnote) ✅ **cosmic-dawn/**
- [x] The Cosmic Web (CMB ±10⁻⁵ ripples as seeds; Zel'dovich collapse x=q+D·ψ weaves filaments, nodes and voids; gravity gain at 0 gives the forever-uniform control) ✅ **cosmic-web/**
- [x] Dark Energy & Cosmic Acceleration (SNe Ia standard candles departing the decelerating Hubble line; vacuum energy, negative pressure and w=p/ρc²; Ω/w sliders flip the a(t) curvature and the fate verdict) ✅ **dark-energy/**
- [x] Galaxy Collisions & Mergers (two grazing passes throw mirror tidal tails; colliding gas clouds compress into starburst flashes; dynamical friction drives the final plunge and relaxation into an elliptical) ✅ **galaxy-merger/**
- [x] Orbital Resonance (drag the ratio slider across 2:1 to see a trail plowed into wobble and ejection; destroyer, guardian and heater cases in one scene; the belt histogram carves real Kirkwood gaps) ✅ **orbital-resonance/**
- [x] Orbital Rendezvous & Docking (Hill-equation petal trajectories with a velocity vector; four-way Δv burns, free drift and a GNC auto-dock mode; success/crash judging at contact) ✅ **rendezvous-docking/**
- [x] Aeroelastic Flutter (live two-DOF typical-section integration with a σ(U) root-locus plot; supercritical exponential blow-up, tear-apart and slow-motion replay; torsion-stiffness/CG sliders and the Tacoma single-DOF bridge mode) ✅ **aeroelastic-flutter/**
- [x] Gliding & Soaring (realistic polar with min-sink and best-glide points; thermal/ridge/still-air wind fields; live MacCready speed-to-fly and albatross shear mode) ✅ **gliding-soaring/**
- [x] The Sea Breeze (time-of-day slider flips the isotherms and reverses the flow; advancing front with cumulus rows and a triggered thunderstorm; latitude-controlled Coriolis veer in a full cross-section gyre) ✅ **sea-breeze/**
- [x] Turbidity Currents (density-contrast and slope sliders drive the g′=g·Δρ/ρ surge; mushroom-head erosion with dated cable-break replays; toe deposition growing a fan live) ✅ **turbidity-current/**
- [x] Vortex Rings (Biot–Savart field rolls the ink jet live; toroidal runway and self-induction; jellyfish propulsion and helicopter VRS lift collapse) ✅ **vortex-ring/**
- [x] Wing Icing (droplet capture and horn growth, rime vs glaze set by cloud temperature; clean/iced C_L–α curves with forward separation; boots burst the ice off and the lift curve rebounds) ✅ **wing-icing/**
- [x] Binary Heap & Priority Queue (array-tree dual view with edges following swapping spheres; sift-up bubbles and slow-motion sift-down; O(n) random build-heap and one-click heapsort rolling onto a sorted shelf) ✅ **binary-heap/**
- [x] Dynamic Programming (naive/memoized/bottom-up modes with the call counter diving 29,860,703→69; pruned gray subtrees hang mid-air; 0-1 knapsack fills its dp grid cell by cell then backtracks the picks) ✅ **dynamic-programming/**
- [x] The FFT Butterfly (real radix-2 with per-stage snapshots, 64 mults folded into 12 butterflies at N=8; bit-reversal X-ray and four signal inputs; N² vs N log N counter race, 1,048,576:10,240 at N=1024) ✅ **fft-butterfly/**
- [x] Reinforcement Learning & Q-Learning (real tabular Q-learning training live at ~120 episodes/s; Q heatmap plus policy arrow field; click to repaint walls/traps which resets Q, ε slider shows stuck vs never-converging) ✅ **q-learning/**
- [x] Correlation & Regression (drag points with the line recomputing live and residual² squares breathing with RSS; the Anscombe quartet in a row, one r four truths; reveal the hidden temperature and within-band fits flatten, plus Galton's slope<1 demo) ✅ **regression-correlation/**
- [x] Power Laws & Zipf's Law (6,000 live drops with preferential attachment, the α slider straightens the bent curve to −1 in seconds; least-squares fits for real word/city/surname data; top-20% share and log/linear axis toggle) ✅ **zipf-power-law/**
- [x] CPU Cache & Locality (64-byte line strip flies into L1; row-green vs column-red sea with live L1/L2/L3 hit counters; two-core MESI lamp theater) ✅ **cpu-cache/**
- [x] GPU Rasterization (draggable vertices, slow-motion per-pixel fill; barycentric color / depth-map views; z-fighting shimmer and verdict, parallel-scale comparison) ✅ **gpu-rasterizer/**
- [x] Grid Frequency & Balancing (swing equation solved live, f(t) plot with ghost overlay; thermal/hydro/wind/solar power bars driving a central rotor; inertia slider replays the same event for A/B) ✅ **grid-frequency/**
- [x] The Optical Mouse (live 18x18 frame stream with prev-frame ghost, SAD heat map with white peak cell, displacement arrow synced to cursor; roughness slider to 0 reproduces glass failure; drag/auto-orbit/flick) ✅ **optical-mouse/**
- [x] The Pacemaker (SA arrest / 3rd-degree AVB / AF cases with synced ECG and 3D heart; spike-capture-wide-QRS slow motion; demand-inhibition toggle with R-on-T warning) ✅ **pacemaker/**
- [x] Mechanical Ventilation (42 alveolar units recruited/collapsed by PEEP; live pressure & flow waveforms; VC/PC modes plus compliance slider reproducing ARDS pressure spike and barotrauma red zone) ✅ **ventilator/**

### Phase 43 deep dives (condensed)

- **belt-drive/** — A tensioned belt drive with tension gradient painted along the strap (orange tight side, blue slack side). Push load torque upward and watch T1/T2 climb until it hits the e^(μθ) red line — at that instant the driven pulley stalls inside the still-running belt and starts glowing red.
- **bolt-preload/** — A half-section bolted joint sits on a Junker vibration rig: hit the shaker and the eccentric cam walks the plates sideways, the preload bar drains cell by cell, and the marked nut visibly rotates back toward disaster. Switch to the wedge washers and the same shake leaves it rock solid.
- **cycloid-gears/** — A generating circle rolls around a pitch circle while a pen traces the exact tooth flank, then two clock wheels (7:14 teeth) mesh with the contact point glowing along the describing-circle arcs. Drag the center-distance slider: the cycloid pair seizes dead while the involute pair beside it just keeps on turning.
- **magnetic-coupling/** — Two magnet rings mesh through a translucent seal wall with live field lines arching across the gap. Hit the stall button: the lines stretch and skew to the limit, the trapped rotor slips back one pole pitch at a time with a flash, and on release it hunts briefly before locking back into sync.
- **scotch-yoke/** — Two machines turn at the same speed: the Scotch yoke traces a mathematically perfect sine while the slider-crank's finite rod drags in a second harmonic. The deviation between the two curves fills in red on a live oscilloscope; pull the rod-length slider toward infinity and watch it collapse.
- **stewart-platform/** — Six telescoping legs carry a hexagonal platform; every slider change is answered instantly by six exact leg-length readouts, because parallel kinematics is a closed-form solution. Run the swell preset and the platform center paints a Lissajous figure, while a wobbly serial arm beside it stacks tolerance cone upon tolerance cone.
- **diels-alder/** — Two π chains rotate toward each other like a zipper, three orange arrows spin one synchronized turn, and in a white flash the six-membered ring snaps shut (ΔH≈−167 kJ/mol). Drag the temperature slider to cross the 105 kJ/mol barrier or flip endo/exo to see the dashed secondary-overlap lines appear.
- **glass-vitrification/** — One box of 120 atoms, two fates: drag the cooling-rate slider slow and they click into a gold-shimmering lattice with a kink on the live V-T plot; drag it fast and they freeze mid-scramble, stained red with residual stress until you hit Anneal.
- **grignard-reaction/** — Watch the reacting carbon turn from red (δ+) to blue (δ−) the instant magnesium donates its electron, then pounce on a carbonyl so a glowing orange C–C bond snaps into existence. Switch substrate to grow 1°/2°/3° alcohols, or drop in water and watch the reagent die on the spot.
- **ksp-precipitation/** — A single drop of concentrated Ba²⁺ into the near-saturated beaker and the whole bottle flashes white with turbidity while the Q marker leaps past the red Ksp tick, then slides back as the ion counters settle onto the equilibrium line; flip between CaCO₃, BaSO₄, CaF₂ and AgI to move the line by eight orders of magnitude.
- **lithium-dendrite/** — Push the C-rate slider toward 3C and watch one bump on the anode grow cell by cell into a needle; the instant it kisses the separator the cell flashes white and the temperature gauge rockets into red thermal runaway. Switch to the graphite anode and the same ions slot quietly between layers instead.
- **photocatalysis/** — A photon strikes the TiO₂ slab, the blue electron and red hole tear apart to opposite shores, and white and teal bubbles rise in an exact 2:1 rhythm; switch the cocatalyst off and the two colors sprint toward each other, flash, and vanish — the bubbles stop dead.
- **cancer-p53/** — A living cell with a visible DNA double helix: damage particles rain down, p53 tetramers light up and swarm to the breaks while the cycle ring slams to a halt at the glowing G1/S checkpoint. Flip p53 off and mutant cells sail through the red light, blossoming into a runaway clone sphere; the radio/chemo button then shows why p53-intact tumors self-destruct while p53-null ones shrug it off.
- **hox-embryogenesis/** — A wave of light sweeps the Hox cluster bead by bead along the chromosome, and the same colors spread head-to-tail across a segmented embryo wired by collinearity lines. Drag the Antp boundary forward and the head segment instantly swaps antennae for legs — the classic Antennapedia — while gradient strength, knockouts (Ubx off = an extra wing pair) and the fly/vertebrate switch rewrite the whole body map.
- **microtubule-dynamics/** — A fluorescence-view centrosome shoots out six microtubules, each flipping between growth (bright GTP caps) and banana-peel collapse, while live counters track catastrophe frequency. Drag the tubulin concentration and the whole population changes character; press Taxol to freeze the dynamics and stall mitosis, or Colchicine to dissolve everything — and watch a lucky tip catch a chromosome to complete search-and-capture.
- **pain-gate-control/** — Signal particles race from a burning skin spot to the dorsal horn: fat yellow myelinated Aδ arrives in a blink while skinny bare C fibers crawl in late. Then rub the neighboring skin — blue Aβ fibers light up the green interneuron, the gate doors swing half-shut and the ascending stream visibly thins; press endorphin and descending fibers from the PAG slam the gate all the way closed.
- **sleep-brainwaves/** — One whole night compressed to 30 seconds: an oscilloscope morphs between spindles, giant δ waves and awake-like REM while a red EMG line flatlines in REM, and a 48-cell sleep tower fills stage by stage. During N3, glowing memory particles stream from the hippocampus up fibers into the cortex — hit the coffee button to sink the adenosine curve, or switch on slow-wave deprivation and watch tomorrow's memory test score slide.
- **vesicle-transport/** — A vesicle buds off the Golgi, sheds its coat, and rides a kinesin down a striped microtubule; then in slow motion four SNARE helices twist together like a zipper, dragging the two membranes to ~1 nm until a fusion pore blossoms and fluorescent cargo floods out. Press the Ca²⁺ button mid-tether to skip straight to the burst, or flip the switch to watch dynein haul the empty vesicle home retrograde.
- **elastic-rebound/** — Fast-forward the timeline and the fence posts across the locked fault twist into an S while the stress bar creeps red; at rupture the bend snaps into a bare offset step, the road breaks, wave rings race out and a "≈1906 San Francisco M7.9, ~6 m" flag pops when the slip is that big.
- **friction-stick-slip/** — A block rides a moving belt while the spring stress bar climbs to its red peak, then everything jumps at once: force collapses, the energy bar dumps, ripples spread and the sawtooth trace draws itself live. Slow the pull speed and Dieterich-style static-friction healing makes every stress drop more violent; switch to fault mode and the same sawtooth becomes an earthquake.
- **heat-conduction/** — The hot-end lattice jitters violently while bright phonon pulses dart for the cold side, scattering off course as the material gets messier; flip to copper and the blue electron gas outraces them all. In composite-wall mode the temperature profile bends steeply through the foam layer — insulation you can read off the slope.
- **heisenberg-uncertainty/** — Drag the slit slider from wide to narrow and the wavefronts fan out on the screen in real time while the Δx·Δp meter stays pinned above the red ħ/2 line. In atomic-scale mode, squeezing the electron cloud toward the nucleus sends the kinetic-energy bar from 0.4 eV to tens of keV — the pressure that keeps atoms from collapsing.
- **pauli-periodic-table/** — A proton slider adds electrons one by one: each one hops from the nucleus into its shell slot while the element name, flame color and chemical mood cycle past, and the "full shell · inert" badge flashes exactly at Z=2, 10, 18. Beside it the ionization-energy sawtooth draws itself — periodicity made visible.
- **stress-strain/** — The test bar stretches elastically, yields, then pinches into a visible waist before snapping with a glowing fracture face and sparks — while the live dot walks the σ-ε diagram through hardening and the post-necking drop. Hit "unload" past yield and the bar returns along the E-slope but stays permanently longer.
- **cosmic-dawn/** — The orange afterglow of recombination fades to black, the first zero-metal star flares inside a dark halo, and fresnel-lit ionization bubbles swell, kiss and merge while the ionized-fraction bar climbs toward a transparent cosmos; a spectrum window sets Pop III's clean blue continuum against the Sun's metal-lined curve.
- **cosmic-web/** — 32,768 particles start as a near-uniform lattice and, under a precomputed Zel'dovich displacement field, pour themselves into walls, filaments and knots while a live density map recolors the web and lights the richest nodes into galaxies; the 2D slice view and the gain-to-zero switch turn "gravity did this" into something you can watch fail.
- **dark-energy/** — A comoving galaxy grid recolors by recession speed while the Hubble diagram beside it reveals distant SNe Ia sagging off the decelerating curve; flip to the a(t) timeline and drag w past −1 to watch the curve bend from concave-down to concave-up on the spot — and the fate verdict flip from heat death to big rip with it.
- **galaxy-merger/** — Two thousand-star disks swing past twice, throwing mirror tidal tails, then spiral in and relax into one golden elliptical while the star-collision counter sits frozen at 0 with a live cross-section expectation of ~10⁻²⁴ — the emptiness of galaxies made quantitative.
- **orbital-resonance/** — Drag the period-ratio slider across 2:1 and Jupiter's repeated tug plows the highlighted asteroid's trail into a wobbling rosette until it is ejected, while the live belt histogram carves gaps at 3:1, 5:2 and 2:1; the Pluto case plots every 3:2 conjunction safely at ~49 AU, never near Neptune's orbit.
- **rendezvous-docking/** — A scripted retro burn at t+1.2 s sends the chaser dipping below and creeping forward while three readouts tell one story: Δa goes negative, closing rate goes positive, range melts away — braking really is the accelerator; arrive at the corridor faster than 0.5 m/s and the panel calls it a crash.
- **aeroelastic-flutter/** — Slide the wind speed past U_f and the wing's gentle sway turns into a bending-torsion spiral as the amplitude bar goes exponential, the phase meter settling near 90°, until the structure tears and slow-motion shows the wreckage fly. Flip to Tacoma mode: 17 m/s is enough for pure torsion to self-destruct.
- **gliding-soaring/** — The altimeter ticks slowly down until the glider banks into a thermal column, particles streaming up under the wing, and after two circles the vario flips from −0.8 to +2.5 m/s. Drag the airspeed slider and watch the dot ride the live polar curve while the MacCready marker re-solves for headwind.
- **sea-breeze/** — Drag the time slider from 09:00 to 15:00: the isotherms bow up over the warming land, the wind vanes swing onshore one by one, and the sea-breeze front lands with a chain of cumulus — push ΔT high enough and lightning bolts off the front. Slide past sunset and the whole circulation quietly reverses.
- **turbidity-current/** — The gate lifts and muddy water dives beneath clear, its curling mushroom head devouring bed grains down the slope while transatlantic cables snap one by one, each stamped with its cut time — 600 km in about 14 hours, just as 1929's broken cables revealed. At the toe the current chokes on its own sediment and the fan visibly grows.
- **vortex-ring/** — A slow-motion ink puff is curled into a ring right before your eyes, then cruises the whole tank and threads a crossing current unharmed. Switch to jellyfish mode to swim on ring pulses, or to the helicopter: pull the descent-rate slider into the VRS band and watch the tip vortices loop back up through the rotor disc as the lift readout collapses.
- **wing-icing/** — Flying through cloud, droplets stick and the leading-edge horn grows drop by drop while the same angle of attack slides down two lift curves at once — the iced one collapsing toward stall at 8°. Hit the de-icer boots and the horn shatters off in falling chunks as the curves snap back together.
- **binary-heap/** — A complete tree lives inside a plain array, parent i over children 2i and 2i+1, parent-child edges following the spheres as they swap. Insert a 77 and watch the bubble sift up level by level; hit extract-max and the tail element parachutes to the top, sinks in slow motion through the swaps, while every max rolls onto a green sorted shelf.
- **dynamic-programming/** — The exponential fib call tree detonates across the screen, then memoization detonates it back down: gray subtrees hang pruned in mid-air while the call counter collapses from 29,860,703 to 69. Switch to bottom-up and the recursion vanishes into a 36-cell table filling left to right; knapsack mode fills its dp grid cell by glowing cell and backlights the winning items.
- **fft-butterfly/** — A real radix-2 engine up to N=1024 draws its own butterfly circuit: signal nodes pour through bit-reversed entry gates and merge stage by stage while two multiply counters race overhead. Slide N to 1024 and the scoreboard freezes at 1,048,576 vs 10,240 as the last of 5,120 butterflies snaps shut.
- **q-learning/** — A tabular Q-agent trains live in an 8×6 grid with walls and traps you can paint in by clicking, the first flailing episode pinned in red while the greedy path snaps straight. The heatmap brightens into signposts and the arrow field bends toward the goal; set ε=0 and the demo agent spins in place, ε=1 and the heatmap never sharpens.
- **regression-correlation/** — Grab any point and the least-squares line yields in real time, red residual squares breathing with the RSS counter; one added outlier yanks the whole fit across the panel. The Anscombe quartet stands in a row wearing identical r=0.816 lines, and pulling the hidden "temperature" axis out of the ice-cream–drowning cloud shatters the spurious correlation into three flat within-band lines.
- **zipf-power-law/** — Six thousand word-drops fall live with probability ∝ count^α, growing a Matthew-effect skyline while the log-log inset stretches from a bent knee to a clean slope −1 line. Drag α from 0 to 1 and a flat multinomial plateau pulls itself straight in about a second; Brown-corpus words, UN metro areas and Chinese surnames re-fit on the same plot.
- **cpu-cache/** — A real direct-mapped L1/L2/L3 engine (4/12/42/200-cycle latencies) streams a request dot across a DRAM matrix: row-major scan leaves a green sea of L1 hits, flip to column-major and the pass drowns in red misses while the col/row cycle ratio counter climbs past 5x. Toggle hardware prefetch and watch the next line ride ahead of a sequential stream.
- **gpu-rasterizer/** — A 26x16 pixel screen rasterizes two draggable triangles with real edge functions: watch the bounding box sweep pixel by pixel, colors arriving as barycentric blends, rejects bouncing off the z-buffer. Hit the z-fight demo and the overlap shimmers white until the depths separate and the buffer settles it; crank the cores slider and the whole frame fills in a blink.
- **grid-frequency/** — One flywheel stands for every synchronous machine on the grid: click a load step and the wheel audibly slows as frequency tumbles past the 49.9 limit line, plant bars rise in sequence, and AGC walks the trace back to 50.00. Drop the sync share and replay the identical event — the ghost curve shows the low-inertia dip digging twice as deep, twice as fast.
- **optical-mouse/** — The correlation is computed for real: two 18x18 frames stream in a floating panel, a 13x13 SAD heat map blooms with a white peak, and the displacement arrow and mini-screen cursor move in lockstep. Drag the roughness slider to zero and the heat map goes flat, the tracker flags failure in red, and the cursor freezes — exactly why mice die on glass.
- **pacemaker/** — A real timing engine drives ECG and a contracting 3D heart: sinus beats march, the SA node dies for 3 seconds, the strip goes flat, and an orange spike nails the ventricle into an instant wide QRS. Switch to DDD in complete heart block and every blocked P gets a tracked ventricular spike; kill demand sensing and the fixed-rate spikes start landing on T waves with red R-on-T warnings.
- **ventilator/** — Real respiratory mechanics drive every breath: watch the pressure ramp fill a row of alveolar bubbles, then drag PEEP upward and collapsed units pop open one by one, exchange area climbing. Push tidal volume into a stiff ARDS lung and the gauge needle slams past 30 cmH2O into the red barotrauma zone while the waveforms grow spiky.
...
- **cable-stayed-bridge/** — A truck crosses and the load path lights up stay by stay: straight tensioned cables carry the deck to the pylon, vertical components stack into ~800 MN of tower compression, the girder takes the axial squeeze — and cutting the back stays lets the midspan drag the tower top inward in real time.
- **esterification/** — Molecules in a cutaway flask: sulfuric acid protonates the carbonyl, ethanol attacks, water leaves ("acid loses OH, alcohol loses H"), and the ester floats to the top layer; a Dean–Stark trap drains the water and the concentration curves swing toward ester while Q tracks its way to K≈4.
- **copper-refining/** — A crude anode thins itself into Cu²⁺ ions that cross the bath and grow a 99.99% cathode; gold and silver sink into the slime bag, zinc/iron/nickel dissolve but never plate, and the Faraday ledger m=ItM/(zF) draws the cathode-mass line at ~0.3 V.
- **trophic-pyramid/** — Sunlight pours into the base of a glass pyramid and golden energy particles climb, leaking dark-red at every level — respiration, feces, the never-eaten; slide transfer efficiency from 5% to 20% and the top-layer glow, the leak density and the hectares of grass under one hawk all jump together.
- **mycorrhiza/** — A soil cutaway: sugar particles flow root→fungus while phosphorus flows hypha→root across a glowing network; drag the phosphate rock away and the hyphae grow to reach it; cut the network and the seedling's P-intake curve sags as its leaves yellow.
- **diffraction-grating/** — Plane wavefronts meet N slits and the screen combs light into sharp maxima: pull N from 2 to 200 and fat fringes pinch into needles, switch to white light and the rainbow unfolds with overlapping orders, while the live I(θ)=(sinNα/sinα)² trace breathes with the screen.
- **joule-thomson/** — Molecules squeeze through a porous plug with enthalpy unchanged: intermolecular "springs" stretch and brighten as potential energy bills the kinetic, the speed colors darken on the cold side — and switching to helium flips both ends warm, with the T–P working point skating along the isenthalp across the inversion curve.
- **radial-velocity/** — A star wobbles around the barycenter while its absorption lines breathe red and blue in the zoom inset; the RV curve fills with error-barred samples, and tipping the inclination to 0° flattens it into noise — the m·sin i limit made visible.
- **diffie-hellman/** — Three paint stations under the eavesdropper's hood: yellow g is public, secret tints go in private, mixed colors travel the wire, and Alice's and Bob's pots land on the same brown K while Eve's stays one step short; small-number mode runs the real mod-23 arithmetic, and Eve's brute-force counter rolls.
- **cpu-pipeline/** — Instruction blocks ride a conveyor through five arch stations; at full flow one finishes every beat (CPI=1), a RAW hazard lights the forwarding shortcut, a load-use pair injects a bubble, and a mispredicted branch flushes the pipe — watch the CPI trace against the ideal line.
- **water-treatment/** — A cutaway plant train: paddle mixing neutralizes zeta potential, flocs snowball and settle, sand catches stragglers, chlorine guards the clearwell; the turbidity trace steps below the 1-NTU line — and the skip-coagulation control clogs the filter black.

### Phase 40 deep dives (condensed)

- **bldc-motor/** — A cutaway motor with its three-phase bridge exposed: the green resultant-field arrow jumps 60° per commutation while the two-pole-pair rotor chases it, the glowing current path re-routes every step, and a live trapezoidal phase-current trace marks each switch; single-step the sequence, or let Hall sensors and back-EMF zero crossings call the timing while PWM holds the speed.
- **torque-converter/** — A toroidal cutaway slings oil particles from impeller to turbine; stall the turbine and the stator's re-aimed return flow multiplies torque 2.1×, ease off and K slides to 1 as the one-way clutch freewheels, then snap the lockup clutch for a no-slip ~99% drive.
- **tower-crane/** — A trolley drags the load along the jib while the moment ledger compares load arm, counterweight and the 1000 kN·m envelope — the allowable-load hyperbola shrinks toward the tip; cross the line and the tower flushes red and tilts as the compressed chords buckle, with the stress view finding the first strut to go.
- **suspension-bridge/** — A truck crosses and the load-path animation hands the weight from deck to hangers to main cable to towers and anchorages; the parabolic cable and H=wL²/8f update with sag, and a resonance excitation replays Tacoma's lesson.
- **dishwasher/** — A cutaway tub runs fill → heat → wash → rinse → dry: 60–70 °C jets fire from arms that spin on recoil torque alone, enzymes and surfactants drop in on cue, and the rinse-aid meter drags surface tension from 72 to ~25 mN/m so water sheets away instead of spotting.
- **circuit-breaker/** — One series loop, two judges: the bimetal's I²t clock for overloads, the magnetic coil's 10 ms snap for shorts; open the contacts and the arc climbs an 11-plate chute until its voltage overshoots the 230 V supply and strangles the current at a forced zero — thermal, magnetic and reset all replayable.
- **hall-heroult/** — A cutaway cell of 960 °C cryolite with ion traffic in both directions: Al³⁺ plating onto the cathode as molten metal, O²⁻ burning the carbon anode away at 0.42 kg C/kg Al; trigger an anode effect for the spark rain, tap the sump with a vacuum ladle, and read the 13–15 MWh/tonne ledger.
- **seafloor-spreading/** — A mid-ocean ridge extrudes basalt that records polarity below the 580 °C Curie point; flip the field and fresh crust records the opposite, striping both flanks mirror-symmetrically; the age ruler and spreading rates reproduce the 1963 Vine–Matthews–Morley magnetic-anomaly profile.
- **hydrothermal-vent/** — Seawater dives into cracks, exits as 350–400 °C black-smoker fluid, and feeds a chemosynthetic food chain; kill the flow and the ecosystem goes dark; particle loops trace the percolate–heat–vent cycle while the lamp sweep finds the tube worms.
- **honeycomb/** — Wax cylinders settle into hexagons in front of you; switch triangle/square/hex tilings to compare wall length for equal area (4.56 / 4.00 / 3.72), flip to the double-layer comb with its shared 109.47° rhombic bottoms, and watch fanning dry the honey from 80% to 18% water.
- **metamorphosis/** — A caterpillar with its hormone panel exposed: inject a 20E peak to molt, and the JH slider decides whether the next instar is larva or pupa; inside the chrysalis, imaginal discs dismantle ~45% of the dry mass while the titer curves narrate every switch.
- **cyclotron/** — Particles spiral outward between the dees as a fixed-frequency RF gap kicks twice per lap; the radius-energy ledger tracks r=mv/(qB) until the deflector plate ejects them — run the −6% detune demo and relativistic lag walks the beam into the wall.
- **dns/** — A query climbs a glowing domain tree — root, TLD, authoritative — with the answer stamped by a TTL; re-ask and the lit caches answer in ~1 ms, clear them and the full climb replays; hit and miss sit two orders of magnitude apart on the latency chart.
- **genetic-algorithm/** — Sixty balls hill-climb a fitness terrain by roulette selection, crossover and mutation, one steppable generation at a time; the μ=0 experiment strands them on the 0.66 local peak, and re-enabled mutation flings a resampled ball across the valley toward 1.00.
- **tsp/** — Glowing cities wait for a tour; random, greedy and 2-opt runs share the length chart as the red X lifts a crossing pair, reverses the segment and re-seats it shorter — step by step or straight to within 5% of the reference optimum.
- **pumped-storage/** — One shaft, two jobs: daytime generation lights the city's grid band, night pumping hauls the water back uphill; the round-trip ledger books 76 of every 100 units while the emergency stop shows the minutes-scale response the grid is buying.

### Phase 39 deep dives (condensed)

- **blast-furnace/** — A cutaway shaft with burden descending and gas climbing: tuyere flames, CO made from CO₂ + hot coke, ore pellets changing hue stepwise to silver, slag floating over iron in the hearth, and taphole pours on demand; the height–temperature chart slides its three reduction zones with blast temperature.
- **premixed-flame/** — One burner port in cutaway: the jet entrains air through the venturi throat, a pale inner cone sits inside a bright blue mantle; close the shutter and yellow soot beads glow and deposit; drive flow below flame speed for lightback, above blow-off for lift-off — the v–S_L map tracks it all.
- **gas-discharge/** — A glass tube between electrodes: at 760 torr nothing; drag pressure to a few torr and the Paschen-curve working point crosses the line — snap, the avalanche ignites; cathode layers, Faraday dark space, striations in the positive column; swap neon/argon/mercury+phosphor for three identities.
- **fluorescence-phosphorescence/** — A 3D Jablonski sculpture with photon beads riding the transitions: S₁ falls fast (fluoresce), T₁ leaks slowly (phosphor); kill the lamp and the green dies while cyan lingers on an exponential tail; a glow stick pumps itself chemically in the dark room.
- **predator-prey/** — Populations orbit a closed loop in the V–P plane while a time tower stacks the history; Hudson Bay lynx–hare records 1845–1935 plot alongside; toggle logistic damping to spiral into coexistence, cull predators to hop loops.
- **lake-turnover/** — A cutaway lake with a glowing thermocline lid; drag the season and watch the surface densify until one gust flips the whole column — tracers surge up, oxygen sinks; keep going into winter and the 0→4 °C stack re-sorts itself under the ice.
- **galaxy-rotation/** — A spiral galaxy of 2000 stars on true v(r) orbits; dark matter to zero and the outer disks trail behind a collapsing Keplerian curve; back to 85% and the curve pins flat; overlay M33's measured points for the real thing.
- **sunspot-cycle/** — A rotating Sun with latitude markers slipping apart; field lines wind from polar loops into toroidal ropes, buoyant tubes punch through as spot pairs marching equatorward; the butterfly diagram and sunspot number build up cycle after cycle.
- **holography/** — A laser, a beam splitter, object and reference beams meeting at a plate that grows live fringes; hit Expose then Replay: the object's ghost floats behind the plate with parallax while an inverted conjugate hangs on the far side; slide the occluder across and the image narrows but never amputates.
- **hash-table/** — Keys fly through a real FNV-1a hopper into glowing buckets; chains grow, or switch to linear probing and watch clusters metastasize; rehash at the 0.75 line and everything re-flies shorter; a 64-bit Bloom array votes "definitely absent" in green.
- **inverted-pendulum/** — A two-wheel rover balancing on a knife edge; shove it and it dashes toward the fall, brakes, and settles — slow motion to 0.1× to watch the counterintuitive order; switch the controller off and it topples on the exponential.
- **freezing-depression/** — An ice surface at molecular zoom: freeze-on and melt-off arrows tied until salt lands and the tie breaks — a melt pit opens into brine; three basins race as the cold room drops, NaCl dying at its eutectic while CaCl₂ keeps working.

### Phase 38 deep dives (condensed)

- **involute-gears/** — A taut string unwrapped from a base circle sweeps the involute flank; contact glides along the line of action at a constant 20° while the live ratio meter stays pinned to the tooth counts. Drag the center distance ±2%: the pressure angle shifts, the ratio doesn't.
- **gear-pump/** — Two gears meshing in a snug housing carry oil tooth-space by tooth-space from suction (blue) to pressure (red); flow = displacement × rpm (16 mL/rev) and the instantaneous-flow trace pulses once per engagement — the un-machined pump's signature.
- **newtons-cradle/** — Pull one ball, exactly one leaves: momentum and energy conservation leave only two outcomes. The rejected 'half speed each' fails the energy ledger; slow to 0.06× and the impact crosses the row as a compression wave.
- **windshield-wiper/** — One crank drives a parallel rocker pair sweeping both blades across a 43° arc in phase; the intermittent timer is pure RC — watch the capacitor climb, the relay fire one wipe, the park switch drain it, with t=R·C·ln(V/(V−Vth)) updating live.
- **toilet-flush/** — A cut-away toilet runs the whole chain: fast tank dump crests the trap weir, the siphon ignites and gulps the bowl empty, air breaks the film, and the float valve refills while the trickle tube rebuilds the seal — three events marked on the level chart.
- **washing-machine/** — Drag the load off-center and spin up: amplitude spikes past the 12 mm guard near resonance, the machine tumbles the load even and spins again; the damping slider separates bounce-forever (0.2) from one-sway-settle (0.35).
- **fire-extinguisher/** — Squeeze, pierce, and nitrogen drives powder to the flame base; the fire triangle dims edge by edge, radical scavenging snaps the chain reaction, CO₂ floods low and smothers, and the gauge sinking into red is the re-ignition countdown.
- **relay/** — A 5 V coil snaps the armature over and lights a 220 V load; the rolling scope catches the −237 V flyback spike until the diode clamps −0.8 V, contact bounce draws saw-teeth, and the latch mode parallels an auxiliary contact across the start button.
- **reverse-osmosis/** — Membrane pores pass water and bounce hydrated ions; drag the piston past seawater's 27 bar and the flow reverses on the spot, the flux-pressure plot crosses zero at J=A(ΔP−π)=0, and the plant hands 95% of the brine pressure back — 2.4 kWh per tonne, computed live.
- **vulcanization/** — Stretch raw rubber and chains slide, leaving permanent set; crosslink with sulfur and the same pull becomes stretched springs that rebound with overshoot; the density slider sweeps tacky → elastic → brittle along G=3νkT.
- **thermite/** — Ignite the magnesium ribbon and a front eats through 240 powder grains, iron sinking under oxide slag; on the energy-hill chart the spark rides the barrier top then rolls down −851.5 kJ/mol; open the tap and 2500 °C iron pours into a rail-weld mold.
- **photochemical-smog/** — Drag a city day from dawn to dark: NO turns to brown NO₂, UV photolyzes it, ozone accumulates through the VOC-peroxy chain, and the inversion lid rises and falls — all four curves computed from a six-species ODE box model.
...
- **airship/** — An 8400 m³ helium envelope nets a few hundred kilograms of lift; pump the fore/aft ballonets to pitch, drop 800 kg of ballast to climb, flip to hydrogen for 7% more lift and a Hindenburg-red warning, and vector the thrust for landing.
...
### Phase 34 · Classic additions, batch 1 (12/12)

- [x] Steam engine (a charging boiler, slide-valve reversal, flywheel smoothing and Watt's centrifugal governor in closed loop; detach the governor to watch overspeed glow red; the indicator-diagram area is net work per turn) ✅ **steam-engine/**
- [x] Roller coaster (the lift chain as the ride's only motor, an mgh = ½mv² ledger, the v²κ ≥ g loop criterion, live felt-g on the airtime hill, a mass slider proving Galileo, ghost-run comparison) ✅ **roller-coaster/**
- [x] Seatbelt (the pendulum inertia lock, a pyro pretensioner cinching 4 cm in 8 ms, a load limiter paying out past 6 kN, the millisecond timeline of a 56 km/h crash, an unbelted head-acceleration comparison curve) ✅ **seatbelt/**
- [x] Zipper (the Y-channel meshing wedges one by one, pry horns for opening, the tan α < μ self-lock criterion, side-pull tests that hold or slip tooth by tooth, a fabric jam) ✅ **zipper/**
- [x] Inkjet printing (the meniscus seal, a thermal bubble boiling a 0.1 μm film in 2 μs as a disposable piston, pinch-off and satellites, the piezo squeeze alternative, the ejection window and a dot-matrix printout) ✅ **inkjet-printing/**
- [x] Heat pipe (evaporation freighted with latent heat, vapor racing on its own Δp, condensation into fins, wick capillary return, near-isothermal vs solid copper gradients, dry-out runaway, posture and wick limits) ✅ **heat-pipe/**
- [x] Atomic clock (the Cs hyperfine 9,192,631,770 Hz that defines the second, state selection + microwave cavity + detector, feedback locking quartz to the resonance peak, automatic re-lock after a thermal kick, GPS's 38 μs/day) ✅ **atomic-clock/**
- [x] Bioluminescence (oxidation inside luciferase's pocket, an excited electron paying its change as one photon, firefly ATP loading, shear-triggered dinoflagellate blooms, cutting O₂ kills the light, 90% cold-light efficiency and spectra) ✅ **bioluminescence/**
- [x] Blood types & transfusion (ABO sugar-badge antigens, natural pentameric IgM bridging, agglutination clots and hemolysis, a live compatibility matrix, O gives to all / AB takes from all, Rh and newborn hemolysis) ✅ **blood-type/**
- [x] Karst cave (rain + soil CO₂ as weak acid dissolving limestone along joints, an underground river hauling the load, CO₂ outgassing at ceiling drops precipitating calcite, millennium-scale stalactites, ×1000 fast-forward, sinkhole collapse) ✅ **karst-cave/**
- [x] Ice halos & sundogs (hexagonal prisms in cirrus, two refractions through the 60° prism, the 21.8° minimum-deviation traffic jam, random tumble = the 22° ring, settled plates = sundogs, red-in/blue-out dispersion) ✅ **ice-halo/**
- [x] Zero-knowledge proofs (the Ali-Baba cave, commit-challenge-response, a bluffor caught half the time, the 1−2⁻ᴺ confidence curve parting from the (1/2)ᴺ luck curve, zero bits leaked) ✅ **zero-knowledge/**

### Phase 35 · Cross-family gap-filling, batch 6 (12/12)

- [x] Quadcopter (diagonal pairs counter-rotating so reaction torques cancel — no tail rotor; a four-motor mix matrix F∝ω², tilt → thrust-vector component → forward acceleration a≈g·tanθ, six degrees of freedom from four scalars) ✅ **quadcopter/**
- [x] Cherenkov radiation (light crawls at c/n in a medium; past the βn>1 threshold Huygens wavelets snap into a cone — an optical Mach cone with cosθ=1/(βn); the Frank–Tamm 1/λ² spectrum paints reactor pools blue) ✅ **cherenkov/**
- [x] The Lorenz attractor (three deterministic equations, no randomness; twin trajectories 10⁻⁶ apart shadow each other then diverge exponentially, λ≈0.906 on a straight log plot; drag ρ past 24.74 and chaos collapses onto fixed points) ✅ **chaos-lorenz/**
- [x] Haber–Bosch (the 945 kJ/mol N≡N triple bond cracked by iron-catalyzed dissociative adsorption; ΔH=−92 kJ/mol sets up Le Chatelier's dilemma — thermodynamics wants cold, kinetics wants hot — resolved at 20 MPa / 450 °C with ammonia constantly condensed away) ✅ **haber-bosch/**
- [x] PCR (94 °C denaturation melts the duplex, 55 °C annealing docks primers A-T/G-C, 72 °C Taq extends; one cycle doubles the template, 30 cycles ≈ 10⁹-fold — a straight line on a log plot) ✅ **pcr/**
- [x] Myelin & saltatory conduction (Schwann-cell wrapping cuts membrane capacitance ~250×, action potentials regenerate only at nodes of Ranvier; 1 m/s vs 120 m/s in a same-screen race; demyelination restores capacitance and conduction fails) ✅ **myelin/**
- [x] The monsoon (water 4.2 vs land 0.8 kJ/(kg·K); summer overheats the continent into a low that sucks sea air and rain inland, winter flips everything; the 4.5 km Tibetan Plateau is the pump; Mumbai takes ~90% of its rain June–September) ✅ **monsoon/**
- [x] Coral reefs & ocean acidification (zooxanthellae supply 90% of the coral's energy; +1.5 °C turns them toxic and the coral bleaches; CO₂ + H₂O → H⁺ eats CO₃²⁻, aragonite saturation Ω falls 4.0→3.3, pH 8.2→8.1 means +30% H⁺) ✅ **coral-reef/**
- [x] Comets (a dirty snowball from the Oort cloud; perihelion sublimation blows a coma — the ion tail blows straight antisolarward while radiation pressure bends the dust tail into an arc; Kepler's second law in a sweeping sector; Earth through the debris stream = a meteor shower; Halley's 76 years) ✅ **comet/**
- [x] Cellular networks (hexagonal cells reuse frequencies N=1/3/7; capacity grows as cells shrink; crossing a boundary the signal curves cross and the call hands over seamlessly; power control avoids drowning your neighbors; Shannon's limit sets the geometry) ✅ **cellular-network/**
- [x] CT scanning (ray projections p=∫μ dl fill a sinogram one angle at a time; filtered back-projection smears them into a slice that sharpens turn by turn; too few angles leaves star artifacts; noise σ∝1/√mAs; Hounsfield units and reading windows) ✅ **ct-scan/**
- [x] Accretion disks (conservation of angular momentum stops the gas and spins up a disk; differential rotation plus turbulence hauls angular momentum out as mass spirals in; gravitational energy becomes light with T∝r^(−3/4), white-hot ISCO to glowing rim; ~6% efficiency vs fusion's 0.7%; the ISCO moves with spin) ✅ **accretion-disk/**

### Phase 36 · Cross-family gap-filling, batch 7 (12/12)

- [x] Rolling bearings (sliding μ≈0.1 swapped for rolling μr≈0.002 — two orders of magnitude cheaper; pure-rolling kinematics: inner race turns, ball centers go half speed, outer race rests, zero slip at the contact; L10=(C/P)³ — double the load, one eighth the life; overload brinelling, cage keeps the balls apart) ✅ **rolling-bearing/**
- [x] Suspension & dampers (the spring banks the bump, the damper spends it as c·v² heat; damping ratio ζ=c/2√(km) in three regimes — 0 bounces forever, 0.35 settles in a cycle and a half, >1 is harsh; undamped over a speed bump the body bounces five times and the tire hops; comfort versus grip) ✅ **suspension-damper/**
- [x] Incandescent vs LED (a filament is a 2700 K blackbody radiator — Wien peak at 1.07 µm in the near IR, only ~7% visible: 60 W for 800 lm, 93% heat; an LED makes photons directly by recombination, 9 W for 1000 lm, 25000 h vs 1000 h) ✅ **incandescent-led/**
- [x] AM & FM modulation (AM writes audio into amplitude, m>1 flips the envelope into distortion; FM writes it into frequency — information never sits in amplitude; a lightning burst crackles the AM output while FM's limiter clips and plays on; Carson bandwidth 2(Δf+fm): 200 kHz buys the cleanliness 10 kHz can't) ✅ **am-fm-modulation/**
- [x] Quantum entanglement & Bell's theorem (same-angle measurements anti-correlate perfectly while each side alone is pure 50/50 — no signalling; local hidden variables force triangle correlations with S≤2, quantum sampling on −cosΔ delivers S=2√2≈2.83, past the classical bound; the 2022 Nobel experiments decided) ✅ **quantum-entanglement/**
- [x] The truth about weightlessness (at 400 km gravity still holds 89% of surface strength — weightlessness is the whole station in free fall; Newton's cannon at 7.9 km/s bends the parabola past the horizon into a circle, one 「fall」 every 92 min; RK4 with four fates; burns and reentry are the real heaviness; the equivalence principle closes) ✅ **microgravity/**
- [x] The digestive tract (macromolecules broken into absorbable units: chewing + amylase, pH 2 stomach acid + pepsin, bile emulsifying fat to ×1000 surface + pancreatic enzymes, 30 m² of villi absorbing into blood, colon reclaiming water + fermenting fiber; pH ladder 7→2→8 tied to the absorption curve) ✅ **digestion/**
- [x] mRNA vaccines (deliver the blueprint, not the virus: LNPs endocytose and escape the endosome, ribosomes print the spike onto the cell surface; the immune drill — presentation, B-cell expansion, antibodies; the second dose lifts titers ×10–100; the real virus meets a days-fast memory response) ✅ **mrna-vaccine/**
- [x] Synaptic plasticity & memory (the NMDA receptor is a coincidence detector — glutamate plus voltage pops the Mg²⁺ plug and lets Ca²⁺ in; a 100 Hz tetanus recruits CaMKII, parks more AMPARs, and the same test pulse jumps from 5 to 18 mV and stays = LTP; AP5 blockade proves the causality; low-frequency LTD undoes it; spine volume breathes with plasticity) ✅ **synaptic-plasticity/**
- [x] JPEG & the DCT (real 8×8 DCT and reconstruction in the page; 64 basis surfaces dim out as quantization zeroes them; energy piles into low frequencies and quantization is the lossy watershed; zigzag + run-length + Huffman finish; drag quality to 8 and blocking plus ringing appear while PSNR falls 55→33 dB) ✅ **jpeg-compression/**
- [x] Carbon allotropes (sp³ diamond: Mohs 10, insulating, transparent vs sp² graphite: conductive in-plane, layers held by van der Waals — pencil marks are sheared sheets; a 40-atom morph rearranges diamond⇄graphite live while the property panel flips; graphene, C60, nanotubes; band diagrams follow) ✅ **carbon-allotropes/**
- [x] The cosmic microwave background (the early universe was an opaque plasma fog; at z≈1100, 380 kyr, recombination clears it and the first light flies free for 13.8 Gyr, stretched ×1100 into a 2.725 K near-perfect blackbody; ±10⁻⁵ blotches are galaxy seeds; Penzias & Wilson's stubborn antenna noise) ✅ **cmb/**

### Phase 41 · Cross-family gap-filling, batch 12 (12/12)

- [x] The screw jack (a screw is an incline wrapped around a cylinder: one turn moves the hand 2πL while the load climbs one lead p; when the thread friction angle ρ′ exceeds the lead angle λ it self-locks — let go and nothing back-drives; efficiency η=tanλ/tan(λ+ρ′) sits at 20–44%, and ball screws buy 90%+ by giving the lock away) ✅ **screw-jack/**
- [x] The cable-stayed bridge (each stay is a straight, tensioned elastic support — vertical components carry the deck, horizontal ones squeeze it; vertical components stack to ~800 MN at the tower base while the girder takes axial compression, so the deck stays thin; no anchorages — Sutong spans 1088 m with a 306 m tower) ✅ **cable-stayed-bridge/**
- [x] Fischer esterification (acetic acid + ethanol ⇌ ethyl acetate + water over H₂SO₄, K≈4; the mechanism is "acid loses OH, alcohol loses H", proven by ¹⁸O labeling; a Dean–Stark trap removes water and Le Chatelier pushes yield from ~60% toward 95%) ✅ **esterification/**
- [x] Copper electrorefining (impure anodes dissolve themselves while 99.99% copper grows on the cathode; gold and silver sink as anode slime, Zn/Fe/Ni stay in the bath; the cell runs on ~0.3 V — no compound torn apart, just electrons ferried — ~350 kWh per tonne via Faraday's law) ✅ **copper-refining/**
- [x] The trophic pyramid (only ~10% survives each level — breathed away, never eaten, or lost to decomposers; 1 kg of top predator stands on 10⁴ kg of producers; energy is a one-way street so the pyramid never inverts — only biomass can flip) ✅ **trophic-pyramid/**
- [x] The mycorrhizal network (hyphae multiply root absorbing area 10–100× to reach phosphorus that diffuses only millimetres; plants pay ~13% of assimilated carbon; the common network wires plants together so seedlings borrow carbon — 13 Gt C flows underground yearly) ✅ **mycorrhiza/**
- [x] The diffraction grating (N equal slits, and only d·sinθ=mλ directions add in phase into principal maxima; more slits mean sharper, brighter lines while secondaries drown; white light fans into a rainbow with overlapping orders; CD grooves at 740 nm, resolution R=mN) ✅ **diffraction-grating/**
- [x] The Joule–Thomson effect (throttling is isenthalpic: real-gas molecules pulled apart pay potential energy out of kinetic — temperature falls; He/H₂ must be pre-cooled below their inversion temperatures — N₂ 621 K, H₂ 202 K, He 45 K; the Linde cycle liquefies air at −196 °C; ideal gases give μ=0) ✅ **joule-thomson/**
- [x] The radial-velocity method (the planet drags the star around their barycenter and its spectral lines breathe red and blue; K=(m_p sin i/M_*)(2πG/P)^{1/3} gives only m·sin i; 51 Pegasi b's 4.23-day, 57 m/s wobble opened the hot-Jupiter door) ✅ **radial-velocity/**
- [x] The Diffie–Hellman key exchange (p and g are public, Alice broadcasts g^a, Bob g^b, each re-applies their own secret to reach g^ab; the eavesdropper must solve discrete log — hopeless at 2048 bits; in paint: mixing is easy, un-mixing isn't) ✅ **diffie-hellman/**
- [x] The five-stage pipeline (IF/ID/EX/MEM/WB — five instructions in five stations, ideally one finished per cycle: ×5 throughput with per-instruction latency unchanged; RAW hazards forward or stall, mispredicted branches flush; the slowest stage sets the clock) ✅ **cpu-pipeline/**
- [x] The water treatment plant (coagulation neutralizes zeta potential so flocs snowball, sedimentation settles them, a metre of sand catches stragglers, chlorine leaves 0.3–0.5 mg/L guarding the pipes; turbidity drops from tens of NTU below 1 for ~0.3 kWh per tonne) ✅ **water-treatment/**

### Phase 40 · Cross-family gap-filling, batch 11 (16/16)

- [x] The brushless DC motor (six MOSFETs form a three-phase bridge as the electronic commutator: the six-step truth table +A−B→+A−C→+B−C→+B−A→+C−A→+C−B advances the stator field 60 electrical degrees per step; Hall sensors or back-EMF zero crossings time it, PWM sets the speed — brushes and their sparking retire at 85–95% efficiency) ✅ **bldc-motor/**
- [x] The torque converter (the impeller slings oil at the turbine — a soft connection that idles and creeps without stalling; at stall the stator re-aims the return flow for K₀≈2.1 torque multiply, at the coupling point its one-way clutch freewheels with K=1, and the lockup clutch restores a ~99% efficient direct drive) ✅ **torque-converter/**
- [x] The tower crane (a moment balance stood on end: 4 t × 25 m = 980 kN·m cancelled by a 10 t counterweight on a 10 m arm; the 1000 kN·m rating crushes allowable load into a hyperbola — only 1.8 t at the 56 m tip; overload fails the compressed chords by Euler buckling first, not the 5–6× safety-factor rope) ✅ **tower-crane/**
- [x] The suspension bridge (every load finds its way home: deck → hangers → main cable → towers in compression, anchorages in tension; H=wL²/8f gives ≈370 MN in both cables at 260 kN/m over a 1280 m span; the Ø0.92 m Golden Gate cable spins 27,572 wires at a safety factor of about 4) ✅ **suspension-bridge/**
- [x] The dishwasher (60–70 °C jets, not a rinse: the nozzle recoil torque τ≈ṁ·v·r·sinθ spins the spray arms with no motor; enzymes cut protein and starch in their 50–65 °C window; 9–12 L of water versus 60–100 L for hand washing) ✅ **dishwasher/**
- [x] The circuit breaker (two judges: the bimetal trips thermally on an I²t curve that tolerates inrush, while the coil's ∝(NI)² pull snaps the contacts in ~10 ms above 5–10×In; the arc chute slices the arc into 11 short segments until its voltage overshoots the supply and forces a current zero) ✅ **circuit-breaker/**
- [x] Hall–Héroult aluminum cells (cryolite melts alumina at 960 °C instead of 2050 °C; Al³⁺ takes 3e⁻ at the cathode and sinks as metal while O²⁻ burns the carbon anode at 0.42 kg C per kg Al; 13–15 MWh per tonne — iron is won chemically, aluminum electrically, the blast furnace's twin) ✅ **hall-heroult/**
- [x] Seafloor spreading (new crust exits the ridge at half the spreading rate; titanomagnetite locks the field's polarity below the 580 °C Curie point, so reversals are painted as stripes mirror-symmetric about the axis — Vine–Matthews–Morley settled it in 1963, and the oldest seafloor is only ~185 Ma) ✅ **seafloor-spreading/**
- [x] Hydrothermal vents (seawater percolates down, the magma chamber heats it to 350–400 °C leaching metals and H₂S, and the "smoke" is mineral precipitate; chemosynthesis — CO₂+O₂+4H₂S→CH₂O+4S+3H₂O — makes hydrogen sulfide the sun of a lightless 2500 m world holding ten-thousand-fold biomass) ✅ **hydrothermal-vent/**
- [x] The honeycomb (bees never draw hexagons: wax cylinders at 35 °C pull themselves into hexes under surface tension and neighbor pressure; the honeycomb theorem — hexagons fence the same area with P/A=3.72 versus the square's 4.00 and triangle's 4.56, 18% less wax; 1 g of wax costs 8 g of honey) ✅ **honeycomb/**
- [x] Insect metamorphosis (ecdysone 20E decides when to molt, juvenile hormone decides what to become: high JH keeps the larva a larva, zero JH opens the pupa; inside, imaginal discs rebuild while ~45% of the dry mass is recycled, and the molt factories retire for good after eclosion) ✅ **metamorphosis/**
- [x] The cyclotron (the magnetic field only turns, the RF gap kicks 2qV per lap; f=qB/(2πm) is speed-independent, so one fixed frequency — 22.9 MHz at 1.5 T — walks protons up a growing spiral to 6.8 MeV in ~37 turns and 1.6 μs; relativistic lag is the classical ceiling) ✅ **cyclotron/**
- [x] DNS (a recursive resolver climbs the tree for you — root, TLD, authoritative — over UDP/53 in ~116 ms; answers carry a TTL so a repeat costs ~1 ms; 13 anycast root addresses spread into 1500+ instances guarding the entrance) ✅ **dns/**
- [x] The genetic algorithm (roulette selection favors the fit, crossover lands children between parents, mutation takes random steps; set μ=0 and the population locks onto the f=0.66 local peak — restore it and a resampled ball crosses the valley toward the f=1.00 global one) ✅ **genetic-algorithm/**
- [x] The traveling salesman (brute force is n! — 3.6 million tours at 10 cities, 1.3 trillion at 15; nearest-neighbor is fast but knots, ~25% over optimal on average; the triangle inequality promises any crossing is fixable, and 2-opt untangles to within 5% of the reference optimum) ✅ **tsp/**
- [x] Pumped-storage hydropower (one reversible shaft: a turbine by day feeding 300 MW to the grid, a pump by night hauling water back uphill; 100 units of electricity in, ~76 out for a 76% round trip; 1–3 minutes to full load and nine-tenths of the world's storage) ✅ **pumped-storage/**

### Phase 39 · Cross-family gap-filling, batch 10 (12/12)

- [x] The blast furnace (coke burns at the tuyeres into CO₂ and hot coke takes the oxygen back to make CO; rising CO strips the ore stepwise Fe₂O₃→Fe₃O₄→FeO→Fe while limestone makes slag; 1500 °C iron sinks, slag floats, each leaves by its own taphole — a counter-current reactor running for twenty years) ✅ **blast-furnace/**
- [x] The premixed flame & the gas stove (the jet entrains primary air Venturi-style; inner premixed cone inside a diffusion mantle; shut the shutter and blue turns yellow — soot glowing as 1200 K blackbody beads; slower than flame speed it lights back, faster it blows off) ✅ **premixed-flame/**
- [x] Gas discharge & neon (at 760 torr the free path is too short; pump to a few torr, electrons reach 21.6 eV and the avalanche sustains itself — cathode glow, Faraday dark space, positive column; neon red, argon violet, mercury+phosphor white; one step across the Paschen curve and the tube snaps alive) ✅ **gas-discharge/**
- [x] Fluorescence & phosphorescence (absorb UV, fall back in nanoseconds = fluorescence, dark when the lamp dies; detour through the spin-forbidden triplet = phosphorescence afterglow; kill the light: fluorescence dies, phosphorescence lingers; glow sticks pump chemistry directly) ✅ **fluorescence-phosphorescence/**
- [x] Predators & prey (two Lotka–Volterra equations spin populations around a closed phase-space loop with peaks a quarter cycle apart; a century of Hudson Bay fur records; add carrying capacity and the loop spirals into coexistence; kick it onto another loop) ✅ **predator-prey/**
- [x] Lake turnover (a summer thermocline seals the top while the deep runs out of oxygen; in autumn the surface reaches the deep's density and one wind turns the whole lake over — oxygen sinks, nutrients rise; the 4 °C anomaly deals the winter deck under the ice) ✅ **lake-turnover/**
- [x] Galaxy rotation curves & dark matter (the 21-cm line measures rotation staying flat to the edge; drag dark matter to zero and the curve collapses to Kepler; at 85% it pins flat near 220 km/s; M33 data overlays flat to 22 kpc) ✅ **galaxy-rotation/**
- [x] Sunspots & the magnetic cycle (differential rotation 25 vs 35 days winds the field; magnetic buoyancy floats flux tubes out as sunspot pairs marching toward the equator; the polar field flips every 11 years, restores over 22; the butterfly diagram accumulates) ✅ **sunspot-cycle/**
- [x] Holography (photography records only intensity and loses phase; reference + object light interferes phase into micron fringes; replay diffracts the original wavefront back; cover half the plate — the image survives with a narrower window) ✅ **holography/**
- [x] Hash tables & the Bloom filter (real FNV-1a hashing into buckets; chaining vs open addressing and its clustering; rehash past α=0.75; a Bloom filter sets k bits with k hashes — "definitely absent" with zero false negatives) ✅ **hash-table/**
- [x] The inverted pendulum & self-balance (any nudge grows as θ̈≈(g/L)θ; a 200 Hz state-feedback controller accelerates toward the fall and inertia rights the body; shove it: dash, brake, steady — cut the loop and it drops) ✅ **inverted-pendulum/**
- [x] Freezing-point depression (salt dilutes the ice interface and breaks the freeze-on/melt-off tie — melt pits bite open; ΔTf=i·Kf·m; NaCl eutectic −21 °C, CaCl₂ −51 °C; ice-salt 3:1 refrigeration) ✅ **freezing-depression/**

### Phase 38 · Cross-family gap-filling, batch 9 (26/26)

- [x] Involute gears (a taut string unwrapped from the base circle sweeps the flank, contact glides on the line of action at a steady 20° — constant ratio; ±2% center-distance error shifts the angle, not the ratio; round teeth jam within one turn) ✅ **involute-gears/**
- [x] The gear pump (two gears meshing in a snug housing carry oil tooth-space by tooth-space from suction to pressure, the meshing point doubling as seal and unloading port; Q = displacement × rpm, 16 mL/rev; without relief grooves each engagement pulses the outlet) ✅ **gear-pump/**
- [x] Newton's cradle (momentum plus energy conservation leaves only two solutions: all stop or swap exactly — one ball in, one out; 'half speed each' fails the energy ledger; slow-mo shows the compression wave crossing the row) ✅ **newtons-cradle/**
- [x] The wiper linkage (crank → center link → parallel rocker pair sweeps both blades across a 43° arc in phase; the intermittent timer is pure RC — capacitor to threshold fires one wipe, the park switch drains it, t=R·C·ln(V/(V−Vth)) sets the pause) ✅ **windshield-wiper/**
- [x] The flush toilet (no pump, no power: the tank dump crests the trap weir, the siphon ignites and gulps the bowl empty; float-valve feedback refills while the trickle tube rebuilds the seal — centimetres of water bar sewer gas) ✅ **toilet-flush/**
- [x] The washing machine (an off-centre load flings F=mrω² into the suspension; past 12 mm near resonance it slows, tumbles the load even, spins again; springs bank, dampers spend, ζ=0.2 bounces on, 0.35 settles; every amplitude peak is a re-distribution) ✅ **washing-machine/**
- [x] The fire extinguisher (knock out one leg of the triangle: nitrogen drives powder up the siphon tube to the flame base — MAP smothers, cools and scavenges H·/OH· radicals; CO₂ at 1.5× air density floods low; a red gauge is the re-ignition countdown) ✅ **fire-extinguisher/**
- [x] The relay (a 5 V, tens-of-mA coil switches a 220 V 10 A load; the release spike L·di/dt hits −237 V until the flyback diode clamps −0.8 V; contact bounce arcs; an auxiliary contact across the start button is the original latch) ✅ **relay/**
- [x] Reverse osmosis (the membrane passes water only; natural osmosis stops near the osmotic pressure — 27 bar for seawater; pump past it and flow reverses, salt rejected; energy recovery hands back 95% of the brine pressure, 2.4 kWh per tonne; concentration polarization taxes the wall) ✅ **reverse-osmosis/**
- [x] Vulcanization (raw rubber is sliding noodles — sticky hot, permanently deformed; sulfur bridges C–Sₓ–C turn stretch into spring-pull; crosslink density is the dial: under-cured is tacky, over-cured cracks, tires sit in between) ✅ **vulcanization/**
- [x] The thermite reaction (2Al+Fe₂O₃→Al₂O₃+2Fe releases 3.98 MJ/kg with iron at 2500 °C; aluminum's oxide locks the downhill road until a >1000 °C magnesium flare knocks on the barrier; the front self-sustains — rail welding in a crucible) ✅ **thermite/**
- [x] Photochemical smog (morning NO oxidizes to brown NO₂, UV<420 nm photolyzes it, O+O₂→O₃; VOC-peroxy chains flip NO→NO₂ without spending ozone, stacking the midday peak; the inversion lid caps the street canyon) ✅ **photochemical-smog/**
...
- [x] The airship (an 8400 m³ helium envelope displaces air; net lift is a few hundred kilograms after self-weight; fore/aft ballonets are elevator and trim; hydrogen buys 7% more lift but the Hindenburg paid its bill; envelope drag makes cruise fuel a rounding error) ✅ **airship/**
...
- [x] Concrete (it doesn't dry, it hydrates — water is a reactant; C₃S + H₂O → C-S-H gel needles bridge grains into stone; strength climbs 30% at 1 d → 65% at 7 d → 100% at 28 d; Abrams's law rewards less water; hydration heat 60–80 °C; rebar matches thermal expansion and pH 13 passivates it; drying means cracks) ✅ **concrete/**
- [x] Shape-memory alloys (NiTiNOL's two lattices: martensite deforms by detwinning — booking strain; heat past Af and atoms glide back to the austenite prototype, returning 8% at once; Af is composition-tuned below body temperature for stents; above Af the 500–800 MPa superelastic plateau survives eyeglass frames) ✅ **shape-memory-alloy/**
- [x] Ferromagnets & domains (exchange coupling locks spins into a federation of domains; a field sweeps walls and rotates domains to saturation; remanence is why magnets magnetize; loop area is heat — narrow loops for cores, wide for permanent magnets; past the Curie point (iron 770 °C, NdFeB ~310 °C) thermal noise wins) ✅ **ferromagnetism/**
- [x] Atmospheric pressure & vacuum (1 kg of air on every cm²; Torricelli's 760 mm mercury holds the first artificial vacuum, water would need 10.33 m; exponential decay with an 8.4 km scale height leaves Everest one third and boiling at ~72 °C; Magdeburg's 16 horses — no suction, only the atmosphere pushing) ✅ **barometer/**
- [x] The twin paradox (each sees the other slow — symmetric; the reunion is not: the traveler is younger; the asymmetry hides in the turnaround's frame switch, and the jumping simultaneity plane swallows Δt=2vd of Earth's line; 4 ly at 0.99c — Earth 8.08 yr vs traveler 1.14; muons and GPS prove it) ✅ **twin-paradox/**
- [x] Neutron stars & pulsars (past 1.4 M☉ electrons merge into protons — 12 km, 2.5 billion tonnes a teaspoon; conservation spins the period to milliseconds and flux to 10⁸–10¹¹ T; the tilted magnetic beacon sweeps Earth — pulses; past the ~2.3 M☉ TOV limit, a black hole; mergers forge gold in kilonovae) ✅ **neutron-star/**
- [x] X-ray imaging (bremsstrahlung continuum plus the 59 keV tungsten K line — the same transitions as flame spectra; >99% of the energy is heat and the anode spins; μ∝Z³ makes bone white and flesh grey; kVp trades penetration for contrast, iodine contrast saves the vessels, noise falls as σ∝1/√N) ✅ **xray-imaging/**
- [x] Wi-Fi (2.4 GHz's three channels against 5 GHz's many; OFDM splits data across dozens of subcarriers while the guard interval turns echoes into allies; CSMA/CA listens then backs off randomly, doubling the window on collision; as SNR falls the MCS steps from 256-QAM to QPSK and throughput drops tenfold) ✅ **wifi/**
- [x] Wound healing (a four-stage pipeline: hemostasis, inflammation clearing, proliferation laying collagen III then vessels and epithelium crawling at 0.5–1 mm/day, remodeling swapping to collagen I with strength capped at 80%; scars never regrow appendages; moist dressings beat scabs by ~40%; infection jams stage two) ✅ **wound-healing/**
- [x] Convolutional networks (flatten-and-connect costs 78,400 parameters versus 9 for a 3×3 kernel swept everywhere — shared weights, local receptive fields; ReLU clips negatives, 2×2 max pooling buys shift tolerance; stacked layers go edges → textures → parts → objects; training is backprop tuning the kernels) ✅ **convolutional-network/**
- [x] Fireworks (three stages in series: black powder 75/15/10 lifts, a delay fuse times the apex, the burst throws stars out at equal speed — a spherical shell; colors are electron jumps — strontium red, barium green, copper blue, sodium yellow; packing geometry draws rings and hearts; sound lags 3 s per km) ✅ **fireworks/**
...
### Phase 34 deep dives (condensed)

- **steam-engine/** — A cutaway horizontal engine: the boiler holds water below and saturated steam above while the fire charges pressure; the eccentric-driven slide valve steams each cylinder end in turn; piston, connecting rod and crank turn reciprocation into rotation and the flywheel smooths the pulses. Watt's governor flies outward with speed and throttles the steam automatically — detach it, shed the load and the rim glows overspeed red. The indicator diagram closes a loop whose area is net work per turn. URL: `?fire=` `?load=` `?t=` `?pause=` `?speed=` `?labels=`
- **roller-coaster/** — The chain hauls the train up a 26 m first hill at constant speed, then physics drives: mgh = ½mv² through the first drop, the loop demands v ≥ √(gr) at the top, the airtime crest lets go when v²κ > g, friction and drag debit the account, eddy brakes collect the last KE. A mass slider never changes the lap time; a ghost replays your previous run for comparison. URL: `?fric=` `?mass=` `?cam=follow` `?t=` `?pause=` `?speed=` `?labels=`
- **seatbelt/** — Free-spinning reel, a pendulum that tips and locks under braking, a pyro pretensioner that cinches 4 cm at 8 ms, a 20 g crumple zone buying 80 ms, a load limiter paying out past 6 kN, an airbag catching the head at 30 ms — plus the unbelted comparison whose red curve peaks five times higher. Scrub the −400…+300 ms timeline directly. URL: `?t=` `?pause=` `?speed=` `?labels=`
- **zipper/** — Two rows of wedges interleave one by one inside the slider's Y-channel; the horns pry them apart on the way back. Pull the tapes sideways and the flanks turn tension into normal pressure — while tan α < μ it self-locks; steepen α past the friction angle and teeth pop out one by one. Feed fabric in and friction jams the slider dead. URL: `?x=` `?alpha=` `?mu=` `?t=` `?pause=` `?speed=` `?labels=`
- **inkjet-printing/** — Surface tension seals the 20 μm orifice; in thermal mode a 2 μs pulse flashes a 0.1 μm film to 300 °C and the bubble squeezes ~10 pL out; too little energy drops nothing, too much drags a satellite. Piezo mode squeezes instead of boiling. Print "HTW" and watch the paper step under the nozzle. URL: `?freq=` `?e=` `?t=` `?pause=` `?speed=` `?labels=`
- **heat-pipe/** — The chip pours heat into the evaporator; latent heat leaves as vapor that races down the core on its own pressure difference, condenses into the fins, and the wick sponges liquid back — nearly isothermal, tens of times copper. Push power past the wick limit (or tilt it against gravity) and the evaporator dries out, spiking red. URL: `?p=` `?fan=` `?wick=` `?t=` `?pause=` `?speed=` `?labels=`
- **atomic-clock/** — A cesium oven beams atoms past a state-selecting magnet, the microwave cavity knocks at 9.19 GHz, flipped atoms land on a hot wire and the detector current traces the resonance bell. Feedback pins the quartz to the peak; a thermal kick drifts the line and the loop chases it back. Drift a day and the error is measured in nanoseconds. URL: `?f=` `?w=` `?t=` `?pause=` `?speed=` `?labels=`
- **bioluminescence/** — A night ocean where stirring the water ignites a bloom of dinoflagellates; the enzyme close-up docks luciferin, admits O₂, and the excited product pays its energy change as one photon. Fireflies first spend an ATP to load the substrate. Cut the oxygen and the light dies — 90% of the chemistry becomes light, not heat. URL: `?stir=` `?t=` `?pause=` `?speed=` `?labels=`
- **blood-type/** — Red cells wear A/B sugar badges; the recipient's plasma already roams with IgM against the missing badge. A mismatched unit gets bridged into clumps that clog the vessel and lyse; the compatibility matrix highlights the live pair; Rh− recipients meet Rh+ blood and the newborn-hemolysis story appears. URL: `?donor=` `?t=` `?pause=` `?speed=` `?labels=`
- **karst-cave/** — Rain picks up soil CO₂ and eats limestone along the joints; the underground river hauls the load away so dissolution never stops; ceiling drops outgas CO₂ and precipitate calcite ring by ring into stalactites. Fast-forward millennia, pour acid rain, or let the hall outgrow its roof and collapse into a sinkhole. URL: `?co2=` `?flow=` `?timerate=` `?t=` `?pause=` `?speed=` `?labels=`
- **ice-halo/** — Cirrus crystals refract sunlight twice through a 60° prism; the deviation curve bottoms at 21.8° where rays pile up. Randomly tumbling crystals paint the full 22° ring; plates settling flat concentrate it into two sundogs that track the sun's altitude — red inside, blue outside, the rainbow's opposite. URL: `?alt=` `?den=` `?t=` `?pause=` `?speed=` `?labels=`
- **zero-knowledge/** — A circular cave with one magic door. Peggy commits into a random side, Victor shouts an exit, and only a true knower always emerges where demanded — a bluffor survives each round with probability 1/2 and gets caught live. The confidence curve 1−2⁻ᴺ climbs toward 1 while zero bits of knowledge leak. URL: `?speed=` `?t=` `?pause=` `?labels=`

### Phase 35 deep dives (condensed)

- **quadcopter/** — Four rotors, two spinning clockwise and two counter-clockwise, so reaction torques cancel without a tail rotor. Throttle adds all four, pitch/roll differentials tilt the frame, and the thrust vector leans with it — the horizontal component shoves the whole craft forward. The attitude instrument, the force-decomposition arrows and the live motor-mix table all track the sliders. URL: `?thr=` `?pitch=` `?roll=` `?yaw=` `?t=` `?pause=` `?labels=` `?spin=`
- **cherenkov/** — A charged particle races through water, whose light crawls at only 0.75c. Below the threshold it trails spherical wavefronts; cross βn=1 and the Huygens wavelets snap into a coherent cone — an optical Mach cone with cosθ=1/(βn), shown by an exact tangent construction. Switch media (water/glass/air), read the live cone angle, and the Frank–Tamm 1/λ² spectrum explains the reactor pool's blue. URL: `?beta=` `?med=` `?t=` `?pause=` `?labels=` `?spin=`
- **chaos-lorenz/** — Two trajectories launched 10⁻⁶ apart chase each other around the butterfly wings for ten seconds, then part company forever; the log-plot of their separation climbs as a straight line with the measured Lyapunov exponent λ≈0.906. Drag ρ past 24.74 and the chaos collapses onto the fixed points; σ and β reshape the flow live. URL: `?rho=` `?sigma=` `?beta=` `?dual=` `?t=` `?pause=` `?labels=` `?spin=`
- **haber-bosch/** — N₂ lands on an iron surface, the 945 kJ/mol triple bond stretches and snaps, and three H₂ add one by one to leave as NH₃. The temperature slider shows the industrial compromise: equilibrium yield (green) falls with heat while rate (orange) rises — the crossing is 450 °C; the pressure piston shoves the equilibrium marker to the right; killing the catalyst raises a wall the molecules bounce off; stopping the condenser lets the reverse reaction claw the yield back. URL: `?T=` `?P=` `?cat=` `?rem=` `?speed=` `?t=` `?pause=` `?labels=` `?spin=`
- **pcr/** — A 3D duplex breathes through the three temperatures: 94 °C melts the hydrogen bonds, 55 °C drops the primers onto their complementary docks, 72 °C grows the new strand bead by bead. The 2ⁿ counter flips 1 → 32 → 1024 → 1.07×10⁹ while the log/linear toggle turns exponential growth into a ruler-straight line. URL: `?cyc=` `?speed=` `?t=` `?pause=` `?labels=` `?spin=`
- **myelin/** — The same axon races itself: naked, the sodium wave regenerates at every patch of membrane and crawls; myelinated, it jumps node to node and wins by 20–100×. Capacitance and speed meters move together; drag the demyelination slider to model multiple sclerosis — nodes flash red and conduction stalls. URL: `?my=` `?d=` `?w=` `?dem=` `?t=` `?pause=` `?labels=` `?spin=`
- **monsoon/** — A wind-vector field of instanced arrows over the Indian Ocean and South Asia flips 180° as the month slider sweeps June → January; moisture particles drain over land and the Mumbai rain bars show 90% of the year falling in four months. One button plays the whole reversal; three presets frame the globe, India and East Asia. URL: `?m=` `?speed=` `?t=` `?pause=` `?labels=` `?spin=`
- **coral-reef/** — Warm the water past +1.5 °C and zooxanthellae are expelled polyp by polyp — the reef bleaches bone-white while accumulated heat-stress weeks tick up. Beside it, the CO₂ corner dissolves molecules into the sea: H⁺ ions multiply, carbonate octahedra thin out and the aragonite crystal shrinks as Ω falls from 4.0 toward 3.3. Presets: 1750 baseline / today / marine heatwave / 560 ppm future. URL: `?dt=` `?speed=` `?t=` `?pause=` `?labels=` `?spin=`
- **comet/** — An e=0.8 ellipse sweeps the dirty snowball past the Sun; the equal-area sector demonstrates Kepler's second law live. Near perihelion a coma blooms and the two tails part company: the blue ion tail blows straight downwind of the solar wind, the dust tail lags into a golden arc under radiation pressure. Step 6 parks Earth in the old debris stream for a meteor shower. URL: `?r=` `?wind=` `?inc=` `?speed=` `?t=` `?pause=` `?labels=` `?spin=`
- **cellular-network/** — A city of hexagonal cells with base-station towers; a phone drives the street and the two strongest-signal curves cross at the boundary — the serving cone hops towers with a "handover α→β" flash and the call never drops. Recolor by reuse pattern N=1/3/7 to see co-channel interference; shrink the cell radius and watch area capacity climb. URL: `?n=` `?r=` `?v=` `?load=` `?t=` `?pause=` `?labels=` `?spin=`
- **ct-scan/** — A real filtered back-projection runs in the page: the tube circles a head phantom, the sinogram fills one angle at a time and the slice sharpens from a blur into skull, ventricles and a bleed. Drop to 18 angles for live star artifacts; raise and lower mAs to watch noise fall as σ∝1/√mAs; switch brain/bone windows; the comparison panel shows the same data invisible in a plain X-ray. URL: `?ang=` `?mAs=` `?t=` `?pause=` `?labels=` `?spin=`
- **accretion-disk/** — Thousands of particles trace logarithmic spiral arms, shearing inward as differential rotation (Ω∝r^(−3/2)) grinds the disk; the color map follows T∝r^(−3/4) from a white-hot ISCO to a dull rim. Drag the spin slider and the ISCO ring slides in while efficiency climbs 5.7% → 32%; the feed-rate slider floods the disk with light; the direct-fall comparison shows a zero-angular-momentum stream plunging straight in. URL: `?m=` `?a=` `?md=` `?t=` `?pause=` `?labels=` `?spin=`

### Phase 36 deep dives (condensed)

- **rolling-bearing/** — A cutaway deep-groove bearing with ten balls orbiting and spinning between the races; sliding μ≈0.1 swaps for rolling μr≈0.002 and the torque/temperature bars drop an order of magnitude. Velocity arrows show pure rolling — inner race at v=ωr, ball centers at half, outer race at rest, zero slip at the contact. Drag the load past C and the raceway brinells on the spot while L10=(C/P)³ collapses; drop the cage and neighboring balls scrub. URL: `?m=` `?r=` `?p=` `?l=` `?x=` `?g=` `?t=` `?pause=` `?labels=` `?spin=`
- **suspension-damper/** — A quarter-car with sprung and unsprung masses rolls over half-sine bumps, washboard or filtered random road. The spring banks the energy; the damper's piston glows with c·v² dissipation. Undamped, the body bounces five times and the tire leaves the road; ζ=0.35 settles in a cycle and a half; the ζ slider sweeps 0–1.2 across all three regimes. URL: `?z=` `?k=` `?v=` `?rd=` `?t=` `?pause=` `?labels=` `?spin=`
- **incandescent-led/** — Flip the switch and the filament sweeps 300→2700 K through the Draper point, invisible to dull red to warm white, exactly on the Planck curve; the visible band is a 7% slice of the radiation ledger at 60 W for 800 lm. The LED's blue chip and phosphor make photons directly: 9 W, 1000 lm, 25000 h. Spectra, lumen counters and heat streams all update live. URL: `?ty=` `?pw=` `?ef=` `?t=` `?pause=` `?labels=` `?spin=`
- **am-fm-modulation/** — Three live waveform ribbons: audio, modulated carrier, demodulated output. AM's envelope is the sound until m>1 flips it into distortion; FM's density is the sound at constant amplitude. Fire the lightning burst: the AM output crackles with noise while FM's limiter flattens the amplitude jitter and plays on. URL: `?m=` `?fc=` `?fa=` `?df=` `?nz=` `?ns=` `?slow=` `?t=` `?pause=` `?labels=` `?spin=`
- **quantum-entanglement/** — A source fires singlet pairs to two dials you can rotate; same settings anti-correlate perfectly while each side alone stays 50/50. The 2×2 tally fills along its diagonal, E(Δ) tracks −cosΔ, and the one-click CHSH run pushes S to 2√2≈2.83 — past the classical bound of 2 that the built-in hidden-variable mode never crosses. URL: `?a=` `?b=` `?auto=` `?t=` `?pause=` `?labels=` `?spin=`
- **microgravity/** — At 400 km the gravity meter still reads 89% of surface g. Newton's cannon integrates real two-body motion: drag the muzzle from 0 to 12 km/s and the live trajectory repaints through four fates — impact, circle at 7.9 km/s, ellipse, escape at 11.2. The elevator cabin cuts its cable and everything floats; light the engine and it all falls toward the tail. URL: `?v=` `?h=` `?t=` `?pause=` `?labels=` `?spin=`
- **digestion/** — A cut-away tract from mouth to colon carries starch chains, protein chains and fat globules past each station: amylase at pH 7, pH 2 acid and pepsin in the stomach, bile emulsifying one oil drop into forty micelles, pancreatic enzymes finishing, and 30 m² of villi absorbing the units into a glowing vessel. The pH ladder 7→2→8 and the absorption curve ride along. URL: `?u=` `?bile=` `?t=` `?pause=` `?labels=` `?spin=`
- **mrna-vaccine/** — The whole scene is a pure function of time on a 0–8 week log scrubber: LNPs fuse, gold mRNA spills out, ribosomes print 160 spikes that stud the membrane, a dendritic cell samples and the lymph-node panel expands B clones as antibody density climbs. The booster button jumps the titer curve an order of magnitude; the encounter overlay compares the vaccinated response with the naive one. URL: `?w=` `?dose=` `?enc=` `?t=` `?pause=` `?labels=` `?spin=`
- **synaptic-plasticity/** — Vesicle fusion, glutamate in the 20 nm cleft, AMPA channels giving the 5 mV baseline; the NMDA gold channels keep their Mg²⁺ plugs until depolarization pops them. One 100 Hz tetanus floods Ca²⁺ sparks, lights CaMKII, parks six extra AMPARs and swells the spine — the next test pulse reads 18 mV and stays. AP5 blocks the plug-pop and the potentiation never happens. URL: `?ap5=` `?t=` `?pause=` `?labels=` `?spin=`
- **jpeg-compression/** — A real forward-DCT → quantize → inverse-DCT pipeline runs per drag of the quality slider: the 64 basis surfaces dim out from the high-frequency corner, blocking and ringing crawl into the reconstruction, the compression counter climbs ×3 → ×21 and PSNR falls 55 → 33 dB. Four procedural test patterns, an error heatmap and click-to-highlight coefficient tiles. URL: `?q=` `?pat=` `?em=` `?hm=` `?sw=` `?t=` `?pause=` `?labels=` `?spin=`
- **carbon-allotropes/** — Five structures one click apart: diamond's tetrahedral network, ABA graphite, a graphene sheet, C60 and a nanotube. The morph button flows the same 40 carbons between diamond and graphite while hybridization, Mohs, conductivity, bond length and density flip in the panel; the pencil demo shears a graphene layer across paper and leaves the mark behind. Band sketches follow each structure. URL: `?s=` `?hb=` `?t=` `?pause=` `?labels=` `?spin=`
- **cmb/** — Scrub 16 kyr → today: in the plasma fog photons jink between electrons; cross recombination and the fog clears, the photon paths snap straight and cool along the Planck color curve from white heat to dim microwave as expansion stretches them ×1100 into today's 2.725 K blackbody. The full-sky mode paints ±200 µK blotches over the celestial sphere — the blueprint of every galaxy. URL: `?age=` `?map=` `?pp=` `?bb=` `?t=` `?pause=` `?labels=` `?spin=`

### Phase 37 deep dives (condensed)

- **lever-pulley/** — A seesaw with live arm rulers and force arrows tilts the moment torque unbalances; the rope block rebuilds for n=1–4, the load rising a few centimeters while the rope end pays n×. The Archimedes preset drops the fulcrum to 9:1: one small weight sinks a meter and nine big ones rise eleven centimeters — the work ledger stays equal on both sides. URL: `?xf=` `?nl=` `?nr=` `?n=` `?arms=` `?t=` `?pause=` `?labels=` `?spin=`
- **concrete/** — Inside a cut-away cube, needle C-S-H crystals grow from cement grains and bridge into a load-bearing mesh while blue water molecules are consumed — hydration, not drying. The strength curve climbs 30/65/100% at 1/7/28 days, the hydration hotspot glows 60–80 °C, and the uncured mode grows a crack network while freezing the chemistry. The formwork test crushes the 1-day cube under the same load the 28-day cube shrugs off. URL: `?wc=` `?age=` `?rb=` `?cure=` `?t=` `?pause=` `?labels=` `?spin=`
- **shape-memory-alloy/** — A NiTi wire bent into a V carries 40 twin domains at ±45°; drag the temperature past Af and a flip wave sweeps the domains as the wire snaps straight, returning its 8% strain. Superelastic mode stretches past a 500–800 MPa plateau on the stress-strain chart and springs back on unload; Af is tunable to just below body temperature — the stent demo. URL: `?tp=` `?af=` `?md=` `?ld=` `?t=` `?pause=` `?labels=` `?spin=`
- **ferromagnetism/** — A cut-away iron block holds 24 domains with magnetization arrows, cancelling at rest. Slide the field: walls migrate, domains flick over one by one to saturation; release and remanence stays; heat past the Curie point and the arrows dance into chaos as the iron nail drops. The B-H loop redraws narrow for silicon steel, wide for NdFeB, with the working point riding the curve. URL: `?h=` `?T=` `?mat=` `?ln=` `?t=` `?pause=` `?labels=` `?spin=`
- **barometer/** — Three scenes: Torricelli's 760 mm column with a glowing vacuum cap; a mountain profile where dragging to 8848 m shrinks the column to ~265 mm and the boiling pot to ~72 °C; and Magdeburg hemispheres whose pull gauge climbs to ~2.7×10⁴ N at 95% vacuum — 16 horses and still no 「suction」, only the atmosphere pushing in. URL: `?h=` `?vac=` `?sc=` `?u=` `?t=` `?pause=` `?labels=` `?spin=`
- **twin-paradox/** — A vertical space-time diagram: Earth's worldline straight, the traveler's bent into a Λ; twin clocks ride the lines with Earth's racing ahead. At the turnaround the traveler's simultaneity plane flips and the red segment it wipes across Earth's line is the missing years — 8.08 vs 1.14 at 0.99c over 4 ly. The age-gap curve climbs monotonically with v; muons and GPS close the case. URL: `?v=` `?d=` `?pl=` `?pp=` `?ab=` `?t=` `?pause=` `?labels=` `?spin=`
- **neutron-star/** — A cut-away neutron star spins with radio cones sweeping from a tilted magnetic axis; each sweep past the observer bumps the pulse counter and the waveform. The mass slider walks the M-R diagram — white-dwarf branch, 12 km plateau — and past ~2.3 M☉ the star collapses into a black hole live; the merger demo rings gravitational waves and forges kilonova gold. URL: `?m=` `?p=` `?obs=` `?fld=` `?t=` `?pause=` `?labels=` `?spin=`
- **xray-imaging/** — An X-ray tube in section fires filament electrons at a spinning tungsten target; the spectrum panel draws bremsstrahlung plus the 59 keV K line. Photons stream through a hand or chest phantom onto a live detector image — white bone, grey flesh — while the kVp slider hardens the spectrum and washes contrast, mA·s grains the noise, and the contrast toggle lights up iodine vessels. URL: `?kv=` `?mas=` `?part=` `?cm=` `?t=` `?pause=` `?labels=` `?spin=`
- **wifi/** — A top-down room, one router, movable devices: spreading waves with wall echoes, an OFDM panel of subcarrier teeth each carrying its bits, and a CSMA/CA timing belt where two countdowns hitting zero collide in red and double their windows. Drag device B through the wall and the MCS ladder steps down from 256-QAM to QPSK — 867 to 88 Mbps. The hidden-node preset shows why RTS/CTS exists. URL: `?d=` `?band=` `?wall=` `?rts=` `?pre=` `?t=` `?pause=` `?labels=` `?spin=`
- **wound-healing/** — A full-thickness cut in a layered skin section closes itself as the log timeline scrubs 0 h → 1 year: the platelet plug, waves of neutrophils and macrophages, collagen III thin threads thickening into I-type cables, vessel buds, and pink epithelium crawling in from both edges. The wet-dressing toggle splits the migration-rate curves; the infection toggle jams the line at inflammation. Strength caps at 80% — scars never regrow glands. URL: `?tm=` `?dep=` `?wet=` `?inf=` `?t=` `?pause=` `?labels=` `?spin=`
- **convolutional-network/** — A real convolution runs in the page: a 3×3 kernel scans the input plane painting the feature map cell by cell, ReLU clips, and 2×2 max pooling collapses 4 tiles into 1. The learned-kernel mode walks a pyramid — edges, textures, parts, object — while the 0–9 confidence bars fill from cosine similarity; the parameters panel keeps score: 78,400 versus 9. URL: `?k=` `?p=` `?ly=` `?sv=` `?pool=` `?t=` `?pause=` `?labels=` `?spin=`
- **fireworks/** — A launch tube fires a shell on black powder; at apex the burst throws 220 stars out at equal speed and the shell snaps into a sphere, colored by whichever salt you've loaded — strontium red, barium green, copper blue, sodium yellow. Switch to ring or heart packing to reshape the pattern, slow time to watch the shell form, and the spectrum panel shows the element's emission lines. URL: `?h=` `?el=` `?ar=` `?metal=` `?slow=` `?t=` `?pause=` `?labels=` `?spin=`
...
steam-engine/         Steam engine: boiler, slide valve, flywheel and Watt's governor (Three.js, CDN)
roller-coaster/       Roller coaster: the energy ledger, loop g's and airtime hills (Three.js, CDN)
seatbelt/             Seatbelt: inertia lock, pretensioner and load limiter (Three.js, CDN)
zipper/               Zipper: Y-channel meshing, pry horns and self-locking (Three.js, CDN)
inkjet-printing/      Inkjet printing: thermal-bubble and piezo droplet ejection (Three.js, CDN)
heat-pipe/            Heat pipe: phase-change transport, capillary return, dry-out (Three.js, CDN)
atomic-clock/         Atomic clock: hyperfine transition and feedback locking (Three.js, CDN)
bioluminescence/      Bioluminescence: cold light from luciferase's pocket (Three.js, CDN)
blood-type/           Blood types: ABO antigens, antibodies and agglutination (Three.js, CDN)
karst-cave/           Karst cave: dissolving and precipitating calcium carbonate (Three.js, CDN)
ice-halo/             Ice halos & sundogs: the 22° minimum deviation (Three.js, CDN)
zero-knowledge/       Zero-knowledge proofs: the Ali-Baba cave protocol (Three.js, CDN)
quadcopter/           Quadcopter: torque cancellation and the four-motor mix matrix (Three.js, CDN)
cherenkov/            Cherenkov radiation: the cone of light past c/n (Three.js, CDN)
chaos-lorenz/         Lorenz attractor: deterministic chaos and the butterfly effect (Three.js, CDN)
haber-bosch/          Haber–Bosch: thermodynamics' bargain with kinetics (Three.js, CDN)
pcr/                  PCR: denature–anneal–extend exponential amplification (Three.js, CDN)
myelin/               Myelin & saltatory conduction: insulation and the nodes of Ranvier (Three.js, CDN)
monsoon/              Monsoon: the land–sea heat-capacity wind reversal (Three.js, CDN)
coral-reef/           Coral reefs: bleaching and acidification's double squeeze (Three.js, CDN)
comet/                Comets: dirty snowballs, two tails and meteor showers (Three.js, CDN)
cellular-network/     Cellular networks: frequency reuse and seamless handover (Three.js, CDN)
ct-scan/              CT scanning: filtered back-projection reconstruction (Three.js, CDN)
accretion-disk/       Accretion disks: angular momentum, turbulence and light from gravity (Three.js, CDN)
rolling-bearing/      Rolling bearings: sliding swapped for rolling, contact kinematics, L10 life (Three.js, CDN)
suspension-damper/    Suspension & dampers: springs store, dampers dissipate, three regimes of ζ (Three.js, CDN)
incandescent-led/     Incandescent vs LED: blackbody filament, visible fraction, lm/W ledger (Three.js, CDN)
am-fm-modulation/     AM & FM: carriers, amplitude/frequency writing, noise attack & defense (Three.js, CDN)
quantum-entanglement/ Quantum entanglement & Bell: anti-correlation, CHSH and 2√2 (Three.js, CDN)
microgravity/         Weightlessness: free fall, the Newton cannon and the equivalence principle (Three.js, CDN)
digestion/            The digestive tract: breaking macromolecules into units, villi absorption (Three.js, CDN)
mrna-vaccine/         mRNA vaccines: LNP delivery, translation and the immune drill (Three.js, CDN)
synaptic-plasticity/  Synaptic plasticity & memory: NMDA coincidence detection, LTP/LTD (Three.js, CDN)
jpeg-compression/     JPEG & the DCT: frequency translation, quantization, artifacts (Three.js, CDN)
carbon-allotropes/    Carbon allotropes: sp³/sp² and five structures (Three.js, CDN)
cmb/                  The CMB: recombination, redshift and the 2.725 K blackbody (Three.js, CDN)
lever-pulley/         Levers & pulleys: torque balance, three classes, rope blocks (Three.js, CDN)
concrete/             Concrete: hydration, strength curves and the rebar partnership (Three.js, CDN)
shape-memory-alloy/   Shape-memory alloys: martensite-austenite and superelasticity (Three.js, CDN)
ferromagnetism/       Ferromagnets & domains: hysteresis loops and the Curie point (Three.js, CDN)
barometer/            Atmospheric pressure & vacuum: Torricelli, Magdeburg, altitude (Three.js, CDN)
twin-paradox/         The twin paradox: the simultaneity jump and proper time (Three.js, CDN)
neutron-star/         Neutron stars & pulsars: degeneracy, beacons, the TOV limit (Three.js, CDN)
xray-imaging/         X-ray imaging: bremsstrahlung, spectra, attenuation imaging (Three.js, CDN)
wifi/                 Wi-Fi: OFDM, CSMA/CA and rate adaptation (Three.js, CDN)
wound-healing/        Wound healing: hemostasis, inflammation, proliferation, remodeling (Three.js, CDN)
convolutional-network/Convolutional networks: kernels, feature maps, hierarchy (Three.js, CDN)
fireworks/            Fireworks: black-powder lift, momentum shells, flame-color jumps (Three.js, CDN)
screw-jack/            Screw jack: an incline wrapped around a cylinder, moment ledger, self-locking (Three.js, CDN)
cable-stayed-bridge/   Cable-stayed bridge: straight stays, tower compression, load path (Three.js, CDN)
belt-drive/             Belt Drive & Tension: Euler slip threshold & the tensioner (Three.js, CDN)
bolt-preload/           Bolt Preload & Loosening: clamp load, the Junker test & locking fixes (Three.js, CDN)
cycloid-gears/          Cycloidal Gears: rolled tooth flanks & center-distance sensitivity (Three.js, CDN)
magnetic-coupling/      Magnetic Coupling: torque through a sealed wall, stall-slip fuse (Three.js, CDN)
scotch-yoke/            Scotch Yoke: exact sine vs slider-crank (Three.js, CDN)
stewart-platform/       Stewart Platform: six legs solve the pose (Three.js, CDN)
diels-alder/            The Diels–Alder Reaction: one concerted turn builds a ring (Three.js, CDN)
glass-vitrification/    Glass & Vitrification: crystallize or freeze the disorder (Three.js, CDN)
grignard-reaction/      The Grignard Reaction: the polarity flip that builds C–C bonds (Three.js, CDN)
ksp-precipitation/      Solubility Product & Precipitation: Q crosses Ksp and the flask clouds (Three.js, CDN)
lithium-dendrite/       Lithium Dendrites: field-focused growth pierces the separator (Three.js, CDN)
photocatalysis/         Photocatalytic Water Splitting: one photon splits water 2:1 (Three.js, CDN)
cancer-p53/             Cancer & the p53 Guardian: the guardian stalls a damaged cycle (Three.js, CDN)
hox-embryogenesis/      Hox Genes & the Body Plan: collinear genes map the body axis (Three.js, CDN)
microtubule-dynamics/   Microtubule Dynamic Instability: GTP caps, catastrophe & rescue (Three.js, CDN)
pain-gate-control/      Pain & Gate Control: rubbing half-closes the dorsal-horn gate (Three.js, CDN)
sleep-brainwaves/       Sleep & Brain Waves: a night compressed to 30 seconds (Three.js, CDN)
vesicle-transport/      Vesicle Transport & SNARE Fusion: SNAREs zipper two membranes into one (Three.js, CDN)
elastic-rebound/        Elastic Rebound & the Seismic Cycle: the S-bending road snaps (Three.js, CDN)
friction-stick-slip/    Friction & Stick-Slip: cold-weld contact & the quake sawtooth (Three.js, CDN)
heat-conduction/        Heat Conduction & Phonons: phonons relay, electrons sprint (Three.js, CDN)
heisenberg-uncertainty/ The Uncertainty Principle: narrow the slit, widen the fan (Three.js, CDN)
pauli-periodic-table/   Pauli Exclusion & the Periodic Table: shells fill, chemistry repeats (Three.js, CDN)
stress-strain/          Stress, Strain & Strength: yield, neck & snap (Three.js, CDN)
cosmic-dawn/            Cosmic Dawn & Reionization: first light bubbles the fog away (Three.js, CDN)
cosmic-web/             The Cosmic Web: ripples weave filaments, nodes & voids (Three.js, CDN)
dark-energy/            Dark Energy & Cosmic Acceleration: distant supernovae bend the Hubble plot (Three.js, CDN)
galaxy-merger/          Galaxy Collisions & Mergers: tidal tails, starburst & a counter at zero (Three.js, CDN)
orbital-resonance/      Orbital Resonance: Jupiter plows the Kirkwood gaps (Three.js, CDN)
rendezvous-docking/     Orbital Rendezvous & Docking: braking is the accelerator (Three.js, CDN)
aeroelastic-flutter/    Aeroelastic Flutter: past critical speed, amplitude goes exponential (Three.js, CDN)
gliding-soaring/        Gliding & Soaring: trading height for distance (Three.js, CDN)
sea-breeze/             The Sea Breeze: the daily reversal of the wind (Three.js, CDN)
turbidity-current/      Turbidity Currents & Density Flow: the seafloor’s underwater avalanche (Three.js, CDN)
vortex-ring/            Vortex Rings: the jet rolls itself into a ring (Three.js, CDN)
wing-icing/             Wing Icing: the ice horn collapses the lift curve (Three.js, CDN)
binary-heap/            Binary Heap & Priority Queue: a tree living in an array (Three.js, CDN)
dynamic-programming/    Dynamic Programming: pruning the exponential tree (Three.js, CDN)
fft-butterfly/          The FFT Butterfly: N² folds into N log N (Three.js, CDN)
q-learning/             Reinforcement Learning & Q-Learning: values seep back from the goal (Three.js, CDN)
regression-correlation/ Correlation & Regression: the line that yields (Three.js, CDN)
zipf-power-law/         Power Laws & Zipf's Law: preferential attachment draws slope −1 (Three.js, CDN)
cpu-cache/              CPU Cache & Locality: 64-byte lines, row-green vs column-red (Three.js, CDN)
gpu-rasterizer/         GPU Rasterization: edge functions & the z-buffer (Three.js, CDN)
grid-frequency/         Grid Frequency & Balancing: 50 Hz as a live balance (Three.js, CDN)
optical-mouse/          The Optical Mouse: 1500 fps texture correlation (Three.js, CDN)
gas-spring/             Gas Spring & Damped Hinge: pressurized nitrogen with a damped last inch (Three.js, CDN)
intermittent-gear/      Intermittent Gearing: locking arcs slice rotation into dwell-and-step (Three.js, CDN)
power-split-ecvt/       Power-Split e-CVT: one planetary set, three rotating partners (Three.js, CDN)
catalytic-hydrogenation/ Catalytic Hydrogenation: a surface splits H₂ so alkenes fall (Three.js, CDN)
diazo-azo-dyes/         Diazotization & Azo Dyes: the -N=N- bridge that makes color (Three.js, CDN)
solvent-extraction/     Solvent Extraction: three small pulls beat one big pull (Three.js, CDN)
autophagy/              Autophagy: the cell eats its own broken parts (Three.js, CDN)
flagellar-motor/        The Flagellar Motor: a proton-driven turbine at 300 rps (Three.js, CDN)
rna-splicing/           RNA Splicing & Alternative Splicing: the spliceosome's lariat cut (Three.js, CDN)
magnetic-reconnection/  Magnetic Reconnection & Solar Flares: field lines snap and fling (Three.js, CDN)
quantum-superposition/  Superposition & Measurement: both arrows until you look (Three.js, CDN)
stern-gerlach/          The Stern–Gerlach Experiment: spin splits into exactly two beams (Three.js, CDN)
microlensing/           Gravitational Microlensing: a planet blinks a background star (Three.js, CDN)
moon-formation/         Giant Impact & the Moon: one giant impact, one moon (Three.js, CDN)
retrograde-motion/      Retrograde Motion: the loop that said heliocentric (Three.js, CDN)
snow-avalanche/         Snow Avalanche: a weak layer lets go (Three.js, CDN)
wave-breaking/          Wave Breaking: the crest that outruns its base (Three.js, CDN)
wingtip-vortices/       Wingtip Vortices & Wake Turbulence: lift's spinning receipt (Three.js, CDN)
bezier-splines/         Bézier Curves & Splines: de Casteljau's shrinking scaffold (Three.js, CDN)
consistent-hashing/     Consistent Hashing: add a node, move 1/N keys (Three.js, CDN)
regex-engine/           Regex & Finite Automata: cars racing through an NFA (Three.js, CDN)
autofocus/              Autofocus: two half-images meeting at zero (Three.js, CDN)
esp-stability/          Electronic Stability Control: one brake to twist the yaw back (Three.js, CDN)
rice-cooker/            The Rice Cooker: dry-boil trip at 105 °C (Three.js, CDN)
pacemaker/              The Pacemaker: the spike that fills a silent beat (Three.js, CDN)
ventilator/             Mechanical Ventilation: positive pressure, PEEP & lung protection (Three.js, CDN)
esterification/        Fischer esterification: acid loses OH, alcohol loses H, water removal shifts K (Three.js, CDN)
copper-refining/       Copper electrorefining: anode dissolves, cathode grows, anode slime (Three.js, CDN)
trophic-pyramid/       Trophic pyramid: 10% transfer and the four leaks (Three.js, CDN)
mycorrhiza/            Mycorrhizal network: carbon-for-phosphorus trade on the common web (Three.js, CDN)
diffraction-grating/   Diffraction grating: d·sinθ=mλ, N slits sharpen the spectrum (Three.js, CDN)
joule-thomson/         Joule–Thomson effect: isenthalpic throttle, inversion temperature, Linde cycle (Three.js, CDN)
radial-velocity/       Radial velocity: the stellar wobble and breathing spectral lines (Three.js, CDN)
diffie-hellman/        Diffie–Hellman: broadcasting g^a, stuck at discrete log (Three.js, CDN)
cpu-pipeline/          Five-stage pipeline: IF-ID-EX-MEM-WB, forwarding and bubbles (Three.js, CDN)
water-treatment/       Water treatment plant: coagulation-sedimentation-filtration-disinfection (Three.js, CDN)
...
condensation-polymerization/ Condensation Polymerization: nylon rope from a phase boundary (Three.js, CDN)
electrophilic-aromatic-substitution/ Electrophilic Aromatic Substitution: break a little, restore at once (Three.js, CDN)
metal-displacement/     The Activity Series & Displacement: the activity series at work (Three.js, CDN)
complement-cascade/     Complement Cascade & Membrane Attack Complex: puncturing the invader with MAC (Three.js, CDN)
endosymbiosis/          Endosymbiosis & the Origin of Organelles: the merger that built your cells (Three.js, CDN)
ubiquitin-proteasome/   Ubiquitin–Proteasome System: the death-tag shredder (Three.js, CDN)
capacitor-dielectric/   Capacitors & Dielectrics: κ× the charge in the same box (Three.js, CDN)
groundwater/            Groundwater & Aquifers: Darcy's law under your feet (Three.js, CDN)
matter-waves/           Matter Waves & Electron Diffraction: electrons interfere too (Three.js, CDN)
cosmic-inflation/       Cosmic Inflation & Flatness: smoothing the baby universe (Three.js, CDN)
planetary-rings/        Planetary Rings & Shepherd Moons: shepherd moons carve the gaps (Three.js, CDN)
venus-greenhouse/       Venus & the Runaway Greenhouse: the twin that boiled (Three.js, CDN)
kite-aerodynamics/      Kites & Tethered Flight: three forces pin a wing (Three.js, CDN)
leidenfrost-effect/     The Leidenfrost Effect: riding a cushion of steam (Three.js, CDN)
water-turbine/          Water Turbines: Pelton, Francis, Kaplan: Pelton, Francis or Kaplan (Three.js, CDN)
numerical-integration/  Numerical Integration & Euler's Method: small steps, big differences (Three.js, CDN)
pca-eigenvectors/       PCA & Eigenvectors: the data grows its own basis (Three.js, CDN)
union-find/             Union-Find & Percolation: two tricks, near-constant time (Three.js, CDN)
fingerprint-sensor/     Fingerprint Sensors: ridges, valleys and capacitors (Three.js, CDN)
robot-vacuum/           Robot Vacuum & SLAM: seeing and mapping are one (Three.js, CDN)
usb-fast-charging/      Fast Charging & USB-PD: a handshake before the watts (Three.js, CDN)
```
